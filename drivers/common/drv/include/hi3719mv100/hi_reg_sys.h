...
typedef union
{
    ...
    struct
    {
        unsigned int    key0_gpio_sel         : 1   ; /* [0]  */
        unsigned int    clk_gpio_sel          : 1   ; /* [1]  */
        unsigned int    data_gpio_sel         : 1   ; /* [2]  */
        unsigned int    csn0_gpio_sel         : 1   ; /* [3]  */
        unsigned int    ir_gpio_sel           : 1   ; /* [4]  */
        unsigned int    reserved_1            : 3   ; /* [7..5]  */
        unsigned int    uart_rxd_gpio_sel     : 2   ; /* [9..8]  */
        unsigned int    uart_txd_gpio_sel     : 2   ; /* [11..10]  */
