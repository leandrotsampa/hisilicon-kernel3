...
typedef union
{
    ...
    struct
    {
        unsigned int    reserved_11           : 1   ; /* [0]  */
        unsigned int    reserved_10           : 1   ; /* [1]  */
        unsigned int    reserved_9            : 2   ; /* [3..2]  */
        ...
        unsigned int    reserved_7            : 2   ; /* [11..10]  */
        unsigned int    i2c2_cken             : 1   ; /* [12]  */
        unsigned int    i2c2_srst_req         : 1   ; /* [13]  */
        unsigned int    reserved_6            : 2   ; /* [15..14]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_10           : 1   ; /* [1]  */
        unsigned int    reserved_9            : 1   ; /* [2]  */
        unsigned int    reserved_8            : 5   ; /* [7..3]  */
...
typedef union
{
    ...
    struct
    {
        unsigned int    hrst_eth_s            : 1   ; /* [0]  */
        unsigned int    eth_cken              : 1   ; /* [1]  */
        unsigned int    ethcore_cksel         : 2   ; /* [3..2]  */
        unsigned int    eth_rmiick_sel        : 1   ; /* [4]  */
        unsigned int    reserved_12           : 1   ; /* [5]  */
        unsigned int    reserved_11           : 2   ; /* [7..6]  */
        unsigned int    reserved_10           : 1   ; /* [8]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_13           : 1   ; /* [5]  */
        unsigned int    reserved_12           : 1   ; /* [6]  */
        unsigned int    reserved_11           : 1   ; /* [7]  */
        unsigned int    reserved_10           : 2   ; /* [9..8]  */
        ...
        unsigned int    pvr_tsi1_pctrl        : 1   ; /* [16]  */
...
typedef struct
{
    ...
    volatile unsigned int           reserved_5[4]            ; /* 0xa8~0xb4 */
    ...
    volatile unsigned int           reserved_6[4]            ; /* 0xdc~0xe8 */
    ...
    volatile unsigned int           reserved_7[2]            ; /* 0x104~0x108 */
    ...
    volatile unsigned int           reserved_10              ; /* 0x170 */
    volatile U_PERI_CRG93           PERI_CRG93               ; /* 0x174 */
    volatile U_PERI_CRG94           PERI_CRG94               ; /* 0x178 */
    volatile U_PERI_CRG95           PERI_CRG95               ; /* 0x17c */
    volatile unsigned int           reserved_11              ; /* 0x180 */
    volatile U_PERI_CRG96           PERI_CRG96               ; /* 0x184 */
    volatile U_PERI_CRG97           PERI_CRG97               ; /* 0x188 */
} S_CRG_REGS_TYPE;
