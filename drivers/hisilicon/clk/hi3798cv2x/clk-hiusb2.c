...
static void inno_phy_config_2p_1(struct hiclk_hw *clk)
{
	...
	*/
	writel(0xa0098c, clk->peri_ctrl_base + PERI_CTRL_USB0);
	writel(0xe0098c, clk->peri_ctrl_base + PERI_CTRL_USB0);
	writel(0xa0098c, clk->peri_ctrl_base + PERI_CTRL_USB0);
	writel(0xa10a0a, clk->peri_ctrl_base + PERI_CTRL_USB0);
	writel(0xe10a0a, clk->peri_ctrl_base + PERI_CTRL_USB0);
	writel(0xa10a0a, clk->peri_ctrl_base + PERI_CTRL_USB0);
	udelay(20);
}
/******************************************************************************/
