...
//******************************************************************************
#ifndef __VEDU_REG_98CV200_H__
#define __VEDU_REG_98CV200_H__
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved2             : 3   ; // [8..6]
        unsigned int    vcpi_csc_en           : 1   ; // [9]
...
typedef union
{
    ...
    struct
    {
        unsigned int    woutstdNum            : 3   ; // [2..0]
        unsigned int    reserved1             : 5   ; // [7..3]
        unsigned int    routstdNum            : 4   ; // [11..8]
...
// Define the union U_VEDU_CSC_COEF0
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc00            : 15  ; // [14..0]
        unsigned int    reserved1             : 1   ; // [15]
        unsigned int    vcpi_csc01            : 15  ; // [30..16]
        unsigned int    reserved0             : 1   ; // [31]
    } bits;
...
// Define the union U_VEDU_CSC_COEF1
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc02            : 15  ; // [14..0]
        unsigned int    reserved1             : 1   ; // [15]
        unsigned int    vcpi_csc10            : 15  ; // [30..16]
        unsigned int    reserved0             : 1   ; // [31]
    } bits;
...
// Define the union U_VEDU_CSC_COEF2
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc11            : 15  ; // [14..0]
        unsigned int    reserved1             : 1   ; // [15]
        unsigned int    vcpi_csc12            : 15  ; // [30..16]
        unsigned int    reserved0             : 1   ; // [31]
    } bits;
...
// Define the union U_VEDU_CSC_COEF3
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc20            : 15  ; // [14..0]
        unsigned int    reserved1             : 1   ; // [15]
        unsigned int    vcpi_csc21            : 15  ; // [30..16]
        unsigned int    reserved0             : 1   ; // [31]
    } bits;
...
// Define the union U_VEDU_CSC_COEF4
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc22            : 15  ; // [14..0]
...
// Define the union U_VEDU_CSC_INDC
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc_indc0        : 9   ; // [8..0]
        unsigned int    vcpi_csc_indc1        : 9   ; // [17..9]
        unsigned int    vcpi_csc_indc2        : 9   ; // [26..18]
...
// Define the union U_VEDU_CSC_OUTDC
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    vcpi_csc_outdc0       : 9   ; // [8..0]
        unsigned int    vcpi_csc_outdc1       : 9   ; // [17..9]
        unsigned int    vcpi_csc_outdc2       : 9   ; // [26..18]
        unsigned int    Reserved_0            : 5   ; // [31..27]
    } bits;
...
//////////////////////////////////////////////// new branch for mmu
// Define the union U_VEDU_RRMAX0
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch00_rrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch01_rrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch02_rrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch03_rrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_RRMAX1
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch04_rrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch05_rrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch06_rrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch07_rrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_RRMAX2
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch08_rrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch09_rrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch10_rrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch11_rrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_RRMAX3
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch12_rrmax            : 5   ; // [4..0]
...
// Define the union U_VEDU_WRMAX0
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch00_wrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch01_wrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch02_wrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch03_wrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_WRMAX1
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch04_wrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch05_wrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch06_wrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch07_wrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_WRMAX2
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch08_wrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch09_wrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch10_wrmax            : 5   ; // [20..16]
        unsigned int    reserved1             : 3   ; // [23..21]
        unsigned int    ch11_wrmax            : 5   ; // [28..24]
        unsigned int    reserved0             : 3   ; // [31..29]
    } bits;
...
// Define the union U_VEDU_WRMAX3
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ch12_wrmax            : 5   ; // [4..0]
        unsigned int    reserved3             : 3   ; // [7..5]
        unsigned int    ch13_wrmax            : 5   ; // [12..8]
        unsigned int    reserved2             : 3   ; // [15..13]
        unsigned int    ch14_wrmax            : 5   ; // [20..16]
...
// Define the union U_VEDU_TMAX
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    wtmax                 : 10  ; // [9..0]
        unsigned int    reserved1             : 6   ; // [15..10]
        unsigned int    rtmax                 : 10  ; // [25..16]
...
// Define the union U_VEDU_SECURE
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    secure_en             : 1   ; // [0]
...
typedef union
{
    ...
    struct
    {
        unsigned int    vcpi_srcy_bypass      : 1   ; // [0]
        unsigned int    vcpi_srcc_bypass      : 1   ; // [1]
        unsigned int    vcpi_srcv_bypass      : 1   ; // [2]
        unsigned int    vcpi_refy_bypass      : 1   ; // [3]
        unsigned int    vcpi_refc_bypass      : 1   ; // [4]
        unsigned int    vcpi_rcny_bypass      : 1   ; // [5]
        unsigned int    vcpi_rcnc_bypass      : 1   ; // [6]
...
// Define the union U_SMMU_FAULT_ID_PTW
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    fault_index_id        : 16  ; // [15..0]
        unsigned int    fault_strm_id         : 16  ; // [31..16]
    } bits;

    // Define an unsigned member
    unsigned int    u32;

} U_VEDU_SMMU_FAULT_ID_PTW;

// Define the union U_SMMU_FAULT_ID_WR
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    fault_index_id_wr     : 16  ; // [15..0]
        unsigned int    fault_str_id_wr       : 16  ; // [31..16]
    } bits;

    // Define an unsigned member
    unsigned int    u32;

} U_VEDU_SMMU_FAULT_ID_WR;

// Define the union U_SMMU_FAULT_ID_RD
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    fault_index_id_rd     : 16  ; // [15..0]
        unsigned int    fault_str_id_rd       : 16  ; // [31..16]
    } bits;

    // Define an unsigned member
    unsigned int    u32;

} U_VEDU_SMMU_FAULT_ID_RD;

// Define the union U_SMMU_FAULT_INFO
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    fault_tlbmiss_err     : 2   ; // [1..0]
        unsigned int    fault_tlbinvalid_err  : 2   ; // [3..2]
        unsigned int    Reserved_0            : 18  ; // [21..4]
        unsigned int    fault_ptw             : 1   ; // [22]
        unsigned int    fault_tbu             : 1   ; // [23]
        unsigned int    fault_ptw_num         : 4   ; // [27..24]
        unsigned int    fault_tbu_num         : 4   ; // [31..28]
    } bits;

    // Define an unsigned member
    unsigned int    u32;

} U_VEDU_SMMU_FAULT_INFO;
...
typedef struct
{
    ...
    volatile U_VEDU_CSC_COEF0       VEDU_CSC_COEF0;
    volatile U_VEDU_CSC_COEF1       VEDU_CSC_COEF1;
    volatile U_VEDU_CSC_COEF2       VEDU_CSC_COEF2;
    volatile U_VEDU_CSC_COEF3       VEDU_CSC_COEF3;
    volatile U_VEDU_CSC_COEF4       VEDU_CSC_COEF4;
    volatile U_VEDU_CSC_INDC        VEDU_CSC_INDC;
    volatile U_VEDU_CSC_OUTDC       VEDU_CSC_OUTDC;
    ...
    volatile U_VEDU_RRMAX0          VEDU_RRMAX0;
    volatile U_VEDU_RRMAX1          VEDU_RRMAX1;
    volatile U_VEDU_RRMAX2          VEDU_RRMAX2;
    volatile U_VEDU_RRMAX3          VEDU_RRMAX3;
    volatile U_VEDU_WRMAX0          VEDU_WRMAX0;
    volatile U_VEDU_WRMAX1          VEDU_WRMAX1;
    volatile U_VEDU_WRMAX2          VEDU_WRMAX2;
    volatile U_VEDU_WRMAX3          VEDU_WRMAX3;
    volatile U_VEDU_TMAX            VEDU_TMAX;
    volatile U_VEDU_SECURE          VEDU_SECURE;
    volatile U_VEDU_CHN_BYPASS      VEDU_CHN_BYPASS;
    volatile unsigned int           RESERVED22[264];
    ...
    volatile unsigned int           RESERVED39[9288];
    ...
    volatile unsigned int           RESERVED42[118];
    volatile unsigned int           SMMU_SCB_TTBR;
    volatile unsigned int           SMMU_CB_TTBR;
    volatile unsigned int           RESERVED43[61];
    volatile unsigned int           SMMU_ERR_RDADDR;
    volatile unsigned int           SMMU_ERR_WRADDR;
    volatile unsigned int           RESERVED44;
    volatile unsigned int           SMMU_FAULT_ADDR_PTW;
    volatile U_VEDU_SMMU_FAULT_ID_PTW    SMMU_FAULT_ID_PTW;
    volatile unsigned int           RESERVED45[2];
    volatile unsigned int           SMMU_FAULT_ADDR_WR;
    volatile unsigned int           SMMU_FAULT_TLB_WR;
    volatile U_VEDU_SMMU_FAULT_ID_WR     SMMU_FAULT_ID_WR;
    volatile unsigned int           RESERVED46;
    volatile unsigned int           SMMU_FAULT_ADDR_RD;
    volatile unsigned int           SMMU_FAULT_TLB_RD;
    volatile U_VEDU_SMMU_FAULT_ID_RD     SMMU_FAULT_ID_RD;
    volatile U_VEDU_SMMU_FAULT_INFO      SMMU_FAULT_INFO;
    volatile unsigned int           RESERVED47[752];
