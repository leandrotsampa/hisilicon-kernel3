...
HI_S32 VENC_DRV_MMZ_Map_OMX(HI_MMZ_BUF_S* pMMZbuf )
{
   HI_S32 s32Ret;
   ...
   if(!pMMZbuf)
   {
    ...
    s32Ret = VENC_DRV_EflMMapToKernel_OMX(pMMZbuf);
...
HI_S32 VENC_DRV_MMZ_UMMap_OMX(HI_MMZ_BUF_S* pMMZbuf )
{
   HI_S32 s32Ret;
   ...
   if(!pMMZbuf)
   {
    ...
    s32Ret = VENC_DRV_EflUMMapToKernel_OMX(pMMZbuf);
   if( HI_SUCCESS != s32Ret )
   {
