...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    dre                   : 1   ; /* [20]  */
        unsigned int    dre_dither_decbps     : 3   ; /* [23..21]  */
        unsigned int    dre_thrhd             : 8   ; /* [31..24]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    buf_latency           : 9   ; /* [19..11]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    realdelayms           : 9   ; /* [28..21]  */
        unsigned int    Reserved_38           : 2   ; /* [31..29]  */
    } bits;
