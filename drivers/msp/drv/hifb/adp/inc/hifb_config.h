...
#if defined(CHIP_TYPE_hi3798cv200_a) || defined(CHIP_TYPE_hi3798cv200_b) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798hv100)
...
#define CONFIG_HIFB_STRIDE_16ALIGN                         16
      ...
      #define CONFIG_HIFB_MMU_SUPPORT              /** 支持smmu地址     **/
      #define CONFIG_HIFB_GP0CSC_USE_HDRMOD        /** GP0 CSC和HDR绑定 **/
      #define CONFIG_HIFB_GP0_GALPHA_SUM_SUPPORT   /** 支持统计GP0像素alpha为0的个数 **/
#endif

/**
 **use crc deal with logo to app
 **使用crc校验的方法实现开机logo平滑过渡,备用方案
 **/
//#define CONFIG_HIFB_CRC_LOGO_TO_APP
...
/******************************* API declaration *****************************/
#ifndef HI_BUILD_IN_BOOT
static inline HI_VOID HI_HIFB_GetStride(HI_U32 u32Width, HI_U32 u32PixDepth, HI_U32 *pu32Stride,HI_U32 u32Align)
{
#ifdef CFG_HI_FB_DECOMPRESS_SUPPORT
    if(4 == u32PixDepth){
        *pu32Stride = ((HI_U32)(((u32Width * u32PixDepth) * 13 + 9)/10) + (u32Align - 1)) & (~(u32Align - 1));
    }else
#endif
    {
        *pu32Stride = (u32Width * u32PixDepth + u32Align - 1) & (~(u32Align - 1));
    }
}
static inline HI_U32 HI_HIFB_GetMemSize(HI_U32 u32Stride,HI_U32 u32Height)
{
    return ((u32Stride *  u32Height + 4096 - 1) & (~(4096 - 1)));
}
#endif
