...
2015/08/27                 y00181162                Created file        
******************************************************************************/
...
static struct sg_table *hifb_memblock_map(struct dma_buf_attachment *attach, enum dma_data_direction direction)
{
    ...
    for_each_sg(pfbtable->sgl, pfbsg, pfbtable->nents, s32Cnt)
    	sg_dma_address(pfbsg) = sg_phys(pfbsg);
