...
SQO5jFWqYtlbjiLfGBhMNk36ktoFyCBq/uJm9HQR9AqSYdfEotWPAAe3eI+EnpAS3wYtq0uU
735RTjtkYKUbRyC9MevxTJb8JO3f3EelETkBzSWOt9CW9BDwTFvWMlFiNdrV+A==#*/
...
HI_BOOL VPSS_TRANS_FB_NeedTrans(VPSS_TRANS_FB_INFO_S *pstTransFbList,HI_DRV_VIDEO_FRAME_S *pstFrame)
{
    ...
    if(((HI_DRV_SOURCE_DTV == enInputSrc) 
			...
			&& (HI_DRV_FT_NOT_STEREO == pstFrame->eFrmType))
