...
iBhf64ITcFc4TBU0TuQuJTULWwUBxbm+QrAJfmJi7PC2LVQ0PdWd0umUw8p7KPlkbKGPy/73
99I45wGzASCL9j2PEYPKQYCyvEvMA2CcvE99FN5jFh3f/LVQGlA6B7y+woe2Ug==#*/
        ...
        if (pstFrameList->stBufListCfg.eBufType == HI_DRV_VPSS_BUF_VPSS_ALLOC_MANAGE)
        {
            ...
            if (pstExtBuf->u32Size != u32ExtBufSize)
            {
                ...
                else
                {
					...
					{
						s32Ret = VPSS_OSAL_AllocateMem(VPSS_MEM_FLAG_SECURE,u32ExtBufSize,
								HI_NULL, 
								"VPSS_MetaBuf", 
								pstExtBuf);
					}
