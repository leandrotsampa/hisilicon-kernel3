...
SQO5jLg2VtJAjqZlWu+qCe+rQPwo8MnZ9bOVg7iMrL6NF1+qDzt8QAul4lREPDEE+yvghSKt
nubKZIgfGMx5FftpgiQG6VDBthxmPfYil8O0LdUiBSF8Aex2MuAa5jEQ95WlFA==#*/
...
HI_S32 VPSS_STTINFO_CcclInit(VPSS_CCCLCNTINFO_S* pstCcclCntInfo, HI_U32 u32Width, HI_U32 u32Heigth)
{
    ...
    s32Ret = HI_DRV_MMZ_AllocAndMap( "VPSS_SttCCCLBuf", HI_NULL, u32TotalBuffSize, 0, &(pstCcclCntInfo->stMMZBuf));
...
#ifdef HI_VPSS_SMMU_SUPPORT
        s32Ret = HI_DRV_SMMU_AllocAndMap( "VPSS_SttNrBuf",
...
#else
    s32Ret = HI_DRV_MMZ_AllocAndMap( "VPSS_SttNrBuf", HI_NULL, u32TotalBuffSize, 0, &(pstNrMadInfo->stMMZBuf));
