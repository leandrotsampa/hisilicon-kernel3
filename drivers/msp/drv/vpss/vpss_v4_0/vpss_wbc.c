...
SQO5jJSvjRUYctzKYH7bQLKVJ3coyIPkweeKqFMFafyxpxKApi5LRi7c7QK+piBxeY2/Ck56
K4pH/zLSRGFsniXQP8SBxBAvc1M47h4x7xOKXoC8Jt/epYOpIjFLiZaUjBKZog==#*/
...
#ifdef HI_VPSS_SMMU_SUPPORT 
    s32Ret = HI_DRV_SMMU_Alloc("VPSS_WbcBuf", u32TotalBuffSize, 0, &stMMU); 
    if (HI_FAILURE == s32Ret)
    {
        VPSS_FATAL("VPSS WBC Alloc memory failed.\n");
        return HI_FAILURE;
    }
    pstWbc->stMMZBuf.u32StartPhyAddr = stMMU.u32StartSmmuAddr;
    pstWbc->stMMZBuf.pu8StartVirAddr = stMMU.pu8StartVirAddr;
    pstWbc->stMMZBuf.u32Size = stMMU.u32Size;
...
HI_S32 VPSS_WBC_DeInit(VPSS_WBC_S* pstWbc)
{
    ...
    if (0 != pstWbc->stMMZBuf.u32StartPhyAddr)
    {
        ...
        stMMU.u32StartSmmuAddr = pstWbc->stMMZBuf.u32StartPhyAddr;
        stMMU.pu8StartVirAddr = pstWbc->stMMZBuf.pu8StartVirAddr;
        stMMU.u32Size = pstWbc->stMMZBuf.u32Size;
