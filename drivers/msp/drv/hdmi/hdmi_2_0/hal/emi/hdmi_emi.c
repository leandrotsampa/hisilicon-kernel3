...
{
    HI_U32 u32PixClk = pstEmiCfg->u32PixClk;
    EMI_FMT_PIXCLK_RANGE_INDEX_E enFmtPixClkRange = FMT_PIXCLK_RANGE_BUTT;
    if(u32PixClk <= HDMI_FMT_PIXCLK_40500)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_0;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_40500 && u32PixClk <= HDMI_FMT_PIXCLK_74250)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_1;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_74250 && u32PixClk <= HDMI_FMT_PIXCLK_111375)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_2;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_111375 && u32PixClk <= HDMI_FMT_PIXCLK_165000)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_3;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_165000 && u32PixClk <= HDMI_FMT_PIXCLK_222750)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_4;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_222750 && u32PixClk <= HDMI_FMT_PIXCLK_297000)
    {
        enFmtPixClkRange = FMT_PIXCLK_RANGE_5;
    }
    else if(u32PixClk > HDMI_FMT_PIXCLK_297000)
    {
