...
typedef enum hiDRV_DISP_WORKING_MODE_E
{
    ...
    HI_DRV_DISP_WORKING_MODE_HISI_HDR10,          /* 输入源为HDR10经过Hisi HDR通路处理的工作模式 */
    HI_DRV_DISP_WORKING_MODE_HISI_BBC,            /* 输入源为BBC经过Hisi HDR通路处理的工作模式 */
...
typedef enum hiDRV_HDR_PLAY_MODE_E
{
    ...
    HI_DRV_HDR_PLAY_MODE_BBC,                 /* output bbc hdr signal */
...
typedef struct hiDRV_DISP_PLAY_INFO_S
{
    ...
    HI_DRV_VIDEO_HDR10_INFO_S           stLastHdr10Info;            /* store last static metadata for hdr10.*/
