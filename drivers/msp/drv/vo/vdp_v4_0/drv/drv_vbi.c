...
HI_S32 DRV_VBI_InitTtx(HI_VOID)
{
    ...
    Ret = DISP_OS_MMZ_AllocAndMap("DISP_TtxPes", VDP_MEM_TYPE_PHY, BUFFER_LEN_16K, 0, &g_TtxSend.TtxPesBuf);
    if (Ret != 0)
    {
    ...
    Ret = DISP_OS_MMZ_AllocAndMap("DISP_TtxData", VDP_MEM_TYPE_PHY, TTX_BLOCK_NUM*BUFFER_LEN_7K, 0, &g_TtxSend.TtxDataBuf);
    if (Ret != 0)
    {
...
HI_S32 DRV_VBI_InitVbi(HI_VOID)
{
    ...
    Ret = DISP_OS_MMZ_AllocAndMap("DISP_VbiPes", HI_NULL, BUFFER_LEN_16K, 0, &g_VbiSend.VbiPesBuf);
    if (Ret != 0)
    {
