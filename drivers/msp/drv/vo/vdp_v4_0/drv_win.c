...
//    if (g_bWinPrivateInformation)
    ...
    -----------------------HDR10 frame info-----------------------------
    */
    if(HI_DRV_VIDEO_FRAME_TYPE_HDR10 == pstNewFrame->enSrcFrameType)
    {
        PROC_PRINT(p,
        "-----------------------HDR10 frame info-----------------------------\n"
        "ColorSpace          :%s\n"
        ...
        "MaxMasterLum        :%d\n"
        "MinMasterLum        :%d\n",
        g_pColorSpaceString[pstNewFrame->unHDRInfo.stHDR10Info.enColorSpace],
        g_pGammaTypeString[pstNewFrame->unHDRInfo.stHDR10Info.enGammaType],
        pstNewFrame->unHDRInfo.stHDR10Info.stMetadata.u32MaxDispMasteringLuminance,
        pstNewFrame->unHDRInfo.stHDR10Info.stMetadata.u32MinDispMasteringLuminance
        );
    }
