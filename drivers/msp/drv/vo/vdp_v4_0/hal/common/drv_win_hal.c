...
HI_VOID TransvertSdkFrameGeneralInfor2Cbb(WIN_HAL_PARA_S *pstPara,CBB_LAYER_CFG_INFO_S *pstCbb_Layer)
{
	...
	if ( pstCbb_Layer->stFrame.en3dSrcFormat == CBB_FT_SBS
		|| pstCbb_Layer->stFrame.en3dSrcFormat == CBB_FT_TAB
		|| pstCbb_Layer->stFrame.en3dSrcFormat == CBB_FT_FPK
		|| pstCbb_Layer->stFrame.en3dSrcFormat == CBB_FT_TILE)
	{			
