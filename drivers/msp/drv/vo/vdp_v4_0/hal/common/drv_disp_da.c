...
HI_S32 DISP_GAMMA_Init(void)
{
	...
	s32Ret = DISP_OS_MMZ_AllocAndMap("DISP_Gamma_RGB", VDP_MEM_TYPE_PHY, u32Size, VDP_MEM_ALIGN, &stMBuf);
    if (s32Ret)
    {
	...
	s32Ret = DISP_OS_MMZ_AllocAndMap("DISP_Gamma_YUV", VDP_MEM_TYPE_PHY, u32Size, VDP_MEM_ALIGN, &stMBuf);
