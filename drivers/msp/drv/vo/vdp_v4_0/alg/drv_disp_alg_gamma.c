...
x64fBBbfX8Qy1t7KgaXnngHHbF1hieLwwOZu/k8frLVgCZ7WqRYYAeJ2mnxuWbOoSHsFSlzA
jFmwYdJgcm5WUVvN+zesBKAmlG1ji0RTFLKVhACol/wwWm/QtwK/0bD7saOlNg==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
...
//debug
		...
		if(j==2)
		{
			printk("--------input R[0]=%d,G[0]=%d,B[0]=%d R[1]=%d,G[1]=%d,B[1]=%d  R[2]=%d,G[2]=%d,B[2]=%d\r\n",
		...
		{
			printk("--------input RR[0]=%d,GG[0]=%d,BB[0]=%d RR[1]=%d,GG[1]=%d,BB[1]=%d  RR[2]=%d,GG[2]=%d,BB[2]=%d\r\n",
					pu16GmmCoef0[0],pu16GmmCoef1[0],pu16GmmCoef2[0],
					pu16GmmCoef0[1],pu16GmmCoef1[1],pu16GmmCoef2[1],
					pu16GmmCoef0[2],pu16GmmCoef1[2],pu16GmmCoef2[2]);
...
//		printk("--------the last KKKKKKKKKKKKKKKKKKKKKKKK=%d\r\n",k);
	    }
    }
    return HI_SUCCESS;
}
...
HI_S32 UpdateGmmCoef(ALG_GMM_MEM_S* pstGmmCoefMem, const HI_U16* pu16GmmCoef,  ALG_GMM_CS_MODE_E enCSMode)
{
    ...
    {
        pu32CurAddr = (HI_U32*)pstGmmCoefMem->stMBufRGB.pu8StartVirAddr; //suppositional address
    ...
    {
        pu32CurAddr = (HI_U32*)pstGmmCoefMem->stMBufYUV.pu8StartVirAddr;
...
//for debug printk address
#if 0
	printk("&&&&&&&&&&&&&&&&&&&&&&add0=0x%8x, add1=0x%8x, add2=0x%8x, add3=0x%8x,\n", 
