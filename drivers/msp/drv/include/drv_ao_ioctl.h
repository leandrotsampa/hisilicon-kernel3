...
typedef struct hiAO_SND_SoundSetDelay_Param_S
{
    HI_UNF_SND_E            enSound;
    HI_UNF_SND_OUTPUTPORT_E enOutPort;
    HI_U32 u32DelayMs;
} AO_SND_SoundSetDelay_Param_S, *AO_SND_SoundSetDelay_Param_S_PTR;
...
/*AO SND command code*/
 ...
 #define CMD_AO_SND_SETADACENABLE _IOWR (HI_ID_AO, 0x1b, AO_SND_Adac_Enable_Param_S)
 #define CMD_AO_SND_GETADACENABLE _IOWR (HI_ID_AO, 0x1c, AO_SND_Adac_Enable_Param_S)
...
#endif
 #define CMD_AO_SND_SETSOUNDDELAY _IOW (HI_ID_AO, 0x3e, AO_SND_SoundSetDelay_Param_S)
 #define CMD_AO_SND_GETSOUNDDELAY _IOWR (HI_ID_AO, 0x3f, AO_SND_SoundSetDelay_Param_S)
...
/*AO Cast command code*/
 ...
 #define CMD_AO_SND_SETEXTDELAYMS _IOWR  (HI_ID_AO, 0x77, AO_SND_Set_ExtDelayMs_Param_S)
