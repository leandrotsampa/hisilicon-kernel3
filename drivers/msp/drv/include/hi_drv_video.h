...
typedef struct hiDRV_VIDEO_HDR10_METADATA_S
{
	HI_U16                u16DispPrimariesX0;		     
    HI_U16                u16DispPrimariesY0;            
    HI_U16                u16DispPrimariesX1;            
    HI_U16                u16DispPrimariesY1;            
    HI_U16                u16DispPrimariesX2;            
    HI_U16                u16DispPrimariesY2;            
    HI_U16                u16WhitePointX;                
    HI_U16                u16WhitePointY;                
...
typedef struct hiDRV_VIDEO_HDR10_INFO_S
{
    ...
    HI_DRV_BT2020_LUMINACE_SYS_TYPE_E enLuminaceSys;
    HI_DRV_VIDEO_HDR10_METADATA_S stMetadata;
}HI_DRV_VIDEO_HDR10_INFO_S;

typedef enum hiDRV_VIDEO_FRAME_TYPE_E
{
    HI_DRV_VIDEO_FRAME_TYPE_SDR = 0,    /**<Normal SDR frame.*/ /**<CNcomment: ??SDR????*/
    HI_DRV_VIDEO_FRAME_TYPE_DOLBY_BL,   /**<Dolby BL frame.*/ /**<CNcomment: Dolby?BL?*/
    HI_DRV_VIDEO_FRAME_TYPE_DOLBY_EL,   /**<Dolby EL frame.*/ /**<CNcomment: Dolby?EL?*/
    HI_DRV_VIDEO_FRAME_TYPE_HDR10,      /**<HDR10 frame.*/ /**<CNcomment: HDR10?*/
    HI_DRV_VIDEO_FRAME_TYPE_BUTT
}HI_DRV_VIDEO_FRAME_TYPE_E;

typedef struct hiDRV_VIDEO_FRAME_S
{    
    HI_DRV_VIDEO_FRAME_TYPE_E   enSrcFrameType;         /**<Source frame type:SDR/Dolby(BL/EL)/HDR10.*/ /**<CNcomment: ???: SDR?/Dolby?(BL/EL)/HDR10? */
	...
	*/
    ...
    union
    {
        HI_DRV_VIDEO_DOLBY_INFO_S   stDolbyInfo;    /**<Dolby frame info.*/ /**<CNcomment: Dolby???*/
        HI_DRV_VIDEO_HDR10_INFO_S   stHDR10Info;    /**<HDR10 frame info.*/ /**<CNcomment:  HDR10???*/
    } unHDRInfo;
}HI_DRV_VIDEO_FRAME_S;
