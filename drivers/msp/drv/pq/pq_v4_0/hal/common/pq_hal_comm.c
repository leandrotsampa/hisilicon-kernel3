...
HI_VOID PQ_HAL_CopyRegBySize(HI_U32* pDstReg, HI_U32* pSrcReg, HI_U32 u32RegSize)
{
    ...
    {
        PQ_HAL_RegWrite((HI_U32*)(pDstReg + i), (HI_U32)(*(pSrcReg + i)));
    }
...
HI_VOID PQ_HAL_UpdateVpssPQ(S_CAS_REGS_TYPE* pDstVpssAddr, S_CAS_REGS_TYPE* pSrcVpssAddr)
{
    ...
    u32ByteSize = VPSS_PQ_REG_SIZE(MOTION_EDGE_LUT_01a, COLOR_BASED_LUT_16d);
...
HI_VOID PQ_HAL_UpdateVdpPQ(S_VDP_REGS_TYPE* pDstVdpAddr, S_VDP_REGS_TYPE* pSrcVdpAddr)
{
    ...
    /* SNR */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_SNR_ENABLE, V0_SNR_DEMO);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVdpAddr->V0_SNR_ENABLE),
                         (HI_VOID*)(&pSrcVdpAddr->V0_SNR_ENABLE), u32ByteSize / 4);

    u32ByteSize = VDP_PQ_REG_SIZE(V0_MOTION_EDGE_LUT_01a, V0_COLOR_BASED_LUT_16d);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVdpAddr->V0_MOTION_EDGE_LUT_01a),
                         (HI_VOID*)(&pSrcVdpAddr->V0_MOTION_EDGE_LUT_01a), u32ByteSize / 4);
#endif

#if 0
#ifdef PQ_ALG_DERING
    /* DERING */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_DR_CTRL, V0_DR_THR26);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVdpAddr->V0_DR_CTRL),
                         (HI_VOID*)(&pSrcVdpAddr->V0_DR_CTRL), u32ByteSize / 4);
#endif

#ifdef PQ_ALG_TNR
    /* TNR */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_TNR_MODE, V0_TNR_TE_YCMT_MAPPING_K2 );
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_TNR_MODE),
                         (HI_VOID*)(&pSrcVpssAddr->V0_TNR_MODE), u32ByteSize / 4);
    u32ByteSize = VDP_PQ_REG_SIZE(V0_TNR_TE_YCEG_MAPPING_CTRL, V0_TNR_EDGE_CMOVING_CK );
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_TNR_TE_YCEG_MAPPING_CTRL),
                         (HI_VOID*)(&pSrcVpssAddr->V0_TNR_TE_YCEG_MAPPING_CTRL), u32ByteSize / 4);
    u32ByteSize = VDP_PQ_REG_SIZE(V0_TNR_CLUT10, V0_TNR_CLUT67 );
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_TNR_CLUT10),
                         (HI_VOID*)(&pSrcVpssAddr->V0_TNR_CLUT10), u32ByteSize / 4);
#endif

#ifdef PQ_ALG_SNR
    /* SNR */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_SNR_ENABLE, V0_SNR_DEMO);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_SNR_ENABLE),
                         (HI_VOID*)(&pSrcVpssAddr->V0_SNR_ENABLE), u32ByteSize / 4);

    u32ByteSize = VDP_PQ_REG_SIZE(MOTION_EDGE_LUT_01a, COLOR_BASED_LUT_16d);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->MOTION_EDGE_LUT_01a),
                         (HI_VOID*)(&pSrcVpssAddr->MOTION_EDGE_LUT_01a), u32ByteSize / 4);
#endif
#ifdef PQ_ALG_DB
    /* DB */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_DB_CTRL, V0_DB_CTRL);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_DB_CTRL),
                         (HI_VOID*)(&pSrcVpssAddr->V0_DB_CTRL), u32ByteSize / 4);

    u32ByteSize = VDP_PQ_REG_SIZE(V0_DB_LUT34, V0_DB_LUT40);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_DB_LUT34),
                         (HI_VOID*)(&pSrcVpssAddr->V0_DB_LUT34), u32ByteSize / 4);

    u32ByteSize = VDP_PQ_REG_SIZE(V0_DB_LUT44, V0_DB_THR3);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_DB_LUT44),
                         (HI_VOID*)(&pSrcVpssAddr->V0_DB_LUT44), u32ByteSize / 4);

    u32ByteSize = VDP_PQ_REG_SIZE(V0_DBD_THDEDGE, V0_DBD_BLKSIZE);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_DBD_THDEDGE),
                         (HI_VOID*)(&pSrcVpssAddr->V0_DBD_THDEDGE), u32ByteSize / 4);
#endif

#ifdef PQ_ALG_DM
    /* DM */
    u32ByteSize = VDP_PQ_REG_SIZE(V0_DM_DIR, V0_DM_THR2);
    PQ_HAL_CopyRegBySize((HI_VOID*)(&pDstVpssAddr->V0_DM_DIR),
                         (HI_VOID*)(&pSrcVpssAddr->V0_DM_DIR), u32ByteSize / 4);
#endif
#endif
...
HI_S32 PQ_HAL_GetVdpDitherEn(HI_BOOL* bOnOff)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_DITHER_CTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->WBC_DHD0_DITHER_CTRL.u32))));/* VDP_LAYER_WBC_HD0 */
...
HI_S32 PQ_HAL_MMZ_AllocAndMap(const char* bufname, char* zone_name, HI_U32 u32Size, int align, PQ_MMZ_BUF_S* pstMBuf)
{
    HI_S32 s32Ret;
