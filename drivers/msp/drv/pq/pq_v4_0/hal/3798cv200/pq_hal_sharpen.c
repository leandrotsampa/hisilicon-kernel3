...
HI_S32 PQ_HAL_EnableSharp(HI_BOOL bOnOff)
{
    ...
    if (u32Data >= VID_MAX)
    {
        HI_PRINT("Error,PQ_HAL_EnableSharp() Select Wrong Video Layer ID\n");
        return HI_FAILURE;
    }

    pVDPReg = PQ_HAL_GetVdpReg();
    SPCTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pVDPReg->SPCTRL.u32)) + u32Data * PQ_VID_OFFSET));
    SPCTRL.bits.sharpen_en = bOnOff;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pVDPReg->SPCTRL.u32)) + u32Data * PQ_VID_OFFSET), SPCTRL.u32);
...
HI_S32 PQ_HAL_SetSharpStrReg(HI_U32 u32Data, HI_U32 u32PeakGain, HI_U32 u32EdgeGain)
{
    ...
    pVdpReg = PQ_HAL_GetVdpReg();
    SPGAIN.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pVdpReg->SPGAIN.u32)) + u32Data * PQ_VID_OFFSET));
    SPGAIN.bits.peak_gain = u32PeakGain;
    SPGAIN.bits.edge_gain = u32EdgeGain;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pVdpReg->SPGAIN.u32)) + u32Data * PQ_VID_OFFSET), SPGAIN.u32);
