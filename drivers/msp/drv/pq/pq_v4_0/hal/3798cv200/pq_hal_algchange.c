...
static HI_VOID PQ_HAL_SetVdpSnrCfgAddr(HI_U32 u32Data, HI_U32 u32Addr)
{
    ...
    V0_SNR_CFGAD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_SNR_CFGAD.u32)) + u32Data * PQ_VP_OFFSET));
    V0_SNR_CFGAD.bits.coef_addr = u32Addr;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_SNR_CFGAD.u32)) + u32Data * PQ_VP_OFFSET), V0_SNR_CFGAD.u32);
    return;
}
...
HI_S32  PQ_HAL_SetVdpSnrParaUpd (HI_U32 u32Data)
{
    ...
    pstVDPReg = PQ_HAL_GetVdpReg();
    V0_PARAUP.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PARAUP.u32)) + u32Data * PQ_VP_OFFSET));
    V0_PARAUP.bits.snr_upd = 0x1;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PARAUP.u32)) + u32Data * PQ_VP_OFFSET), V0_PARAUP.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetVdpSnrEnable(HI_U32 u32Data, HI_U32 u32Data1)
{
    ...
    pstVDPReg = PQ_HAL_GetVdpReg();
    V0_PRERD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PRERD.u32)) + u32Data * PQ_VP_OFFSET));
    V0_PRERD.bits.snr_en = u32Data1;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PRERD.u32)) + u32Data * PQ_VP_OFFSET), V0_PRERD.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_InitVdpSnr(HI_VOID)
{
    ...
    memcpy((HI_U32*)(g_stIPSelAlgBuffer.pu8StartVirAddr + u32SNRAddrOffset), (HI_U32*) & (pstVirReg->VPSS_SNR_ENABLE), u32SNRParaSize);
...
HI_S32 PQ_HAL_SetTnrEnable(HI_U32 u32Data, HI_U32 u32En)
{
    ...
    V0_PRERD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PRERD.u32)) + u32Data * PQ_VID_OFFSET));
    V0_PRERD.bits.tnr_en = u32En;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_PRERD.u32)) + u32Data * PQ_VID_OFFSET), V0_PRERD.u32);
...
HI_S32 PQ_HAL_SetTnrWbcEnable(HI_U32 u32Data, HI_U32 u32Enable)
{
    ...
    WBC_FI_CTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_CTRL.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_FI_CTRL.bits.wbc_en = u32Enable;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_CTRL.u32)) + u32Data * PQ_VID_OFFSET), WBC_FI_CTRL.u32);
...
HI_S32 PQ_HAL_SetTnrWbcRegUp(HI_U32 u32Data)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_UPD.u32)) + u32Data * PQ_VID_OFFSET), WBC_FI_UPD.u32);
...
HI_S32 PQ_HAL_SetTnrWbcAddr(HI_U32 u32Data, HI_U32 u32YAddr, HI_U32 u32CAddr)
{
    ...
    WBC_FI_YADDR.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_YADDR.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_FI_CADDR.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_CADDR.u32)) + u32Data * PQ_VID_OFFSET));

    WBC_FI_YADDR.bits.wbcaddr = u32YAddr;
    WBC_FI_CADDR.bits.wbcaddr = u32CAddr;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_YADDR.u32)) + u32Data * PQ_VID_OFFSET), WBC_FI_YADDR.u32);
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_CADDR.u32)) + u32Data * PQ_VID_OFFSET), WBC_FI_CADDR.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetTnrWbcStride(HI_U32 u32Data, HI_U32 u32YStride, HI_U32 u32CStride)
{
    ...
    WBC_FI_STRIDE.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_STRIDE.u32)) + u32Data * PQ_VID_OFFSET));

    WBC_FI_STRIDE.bits.wbclstride = u32YStride;
    WBC_FI_STRIDE.bits.wbccstride = u32CStride;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_FI_STRIDE.u32)) + u32Data * PQ_VID_OFFSET), WBC_FI_STRIDE.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetMadWbcAddr(HI_U32 u32Data, HI_U32 u32YAddr)
{
    ...
    WBC_ME_YADDR.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_YADDR.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_ME_YADDR.bits.wbcaddr = u32YAddr;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_YADDR.u32)) + u32Data * PQ_VID_OFFSET), WBC_ME_YADDR.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetMadWbcStride(HI_U32 u32Data, HI_U32 u32YStride)
{
    ...
    WBC_ME_STRIDE.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_STRIDE.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_ME_STRIDE.bits.wbclstride = u32YStride;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_STRIDE.u32)) + u32Data * PQ_VID_OFFSET), WBC_ME_STRIDE.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetTnrRefDataWidth(HI_U32 u32Data, HI_U32 u32Data1)
{
    ...
    V0_VPSSIP_CTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_VPSSIP_CTRL.u32)) + u32Data * PQ_VID_OFFSET));
    V0_VPSSIP_CTRL.bits.data_width = u32Data1;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_VPSSIP_CTRL.u32)) + u32Data * PQ_VID_OFFSET), V0_VPSSIP_CTRL.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetMadWbcDataMode(HI_U32 u32Data, HI_U32 mad_data_mode)
{
    ...
    WBC_ME_CTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_CTRL.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_ME_CTRL.bits.mad_data_mode = mad_data_mode;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_CTRL.u32)) + u32Data * PQ_VID_OFFSET), WBC_ME_CTRL.u32);
...
HI_S32  PQ_HAL_SetTnrPreAddr   (HI_U32 u32Data, HI_U32 u32LAddr, HI_U32 u32CAddr, HI_U32 u32LStr, HI_U32 u32CStr)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_P1LADDR.u32)) + u32Data * PQ_VID_OFFSET), u32LAddr);
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_P1CADDR.u32)) + u32Data * PQ_VID_OFFSET), u32CAddr);

    V0_P1STRIDE.bits.surface_stride = u32LStr;
    V0_P1STRIDE.bits.surface_cstride = u32CStr;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_P1STRIDE.u32)) + u32Data * PQ_VID_OFFSET), V0_P1STRIDE.u32);
...
HI_S32  PQ_HAL_SetTnrMadAddr   (HI_U32 u32Data, HI_U32 u32LAddr, HI_U32 u32LStr)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_P2LADDR.u32)) + u32Data * PQ_VID_OFFSET), u32LAddr);

    V0_P2STRIDE.bits.surface_stride = u32LStr;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_P2STRIDE.u32)) + u32Data * PQ_VID_OFFSET), V0_P2STRIDE.u32);
...
HI_S32 PQ_HAL_SetTnrCfgAddr(HI_U32 u32Data, HI_U32 u32Addr)
{
    ...
    V0_TNR_CFGAD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_TNR_CFGAD.u32)) + u32Data * PQ_VID_OFFSET));
    V0_TNR_CFGAD.bits.coef_addr = u32Addr;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_TNR_CFGAD.u32)) + u32Data * PQ_VID_OFFSET), V0_TNR_CFGAD.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_SetTnrLutAddr(HI_U32 u32Data, HI_U32 u32Addr)
{
    ...
    V0_TNR_LUTAD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_TNR_LUTAD.u32)) + u32Data * PQ_VID_OFFSET));
    V0_TNR_LUTAD.bits.coef_addr = u32Addr;

    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_TNR_LUTAD.u32)) + u32Data * PQ_VID_OFFSET), V0_TNR_LUTAD.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_InitVdpTnr(HI_VOID)
{
    ...
    memcpy((HI_U32*)(g_stIPSelAlgBuffer.pu8StartVirAddr + u32TNRAddrOffset), (HI_U32*) & (pstVirReg->VPSS_TNR_MODE), u32TNRParaSize);
    ...
    memcpy((HI_U32*)(g_stIPSelAlgBuffer.pu8StartVirAddr + u32TNRAddrOffset), (HI_U32*) & (pstVirReg->VPSS_TNR_CLUT10), u32TNRParaSize);
...
HI_VOID PQ_HAL_SetSmmuLBypass(PQ_LAYER_WBC_E enLayer, HI_U32 u32Enable)
{
    ...
    WBC_DHD0_SMMU_BYPASS.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_DHD0_SMMU_BYPASS.u32)) + enLayer * PQ_WBC_OFFSET));
    WBC_DHD0_SMMU_BYPASS.bits.l_bypass = u32Enable;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_DHD0_SMMU_BYPASS.u32)) + enLayer * PQ_WBC_OFFSET), WBC_DHD0_SMMU_BYPASS.u32);
}
...
HI_VOID PQ_HAL_Set16RegionSmmuLumBypass (HI_U32 u32Data, HI_U32 u32Num, HI_U32 u32Bypass)
{
    ...
    pstVDPReg = PQ_HAL_GetVdpReg();
    V0_SMMU_BYPASS0.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_SMMU_BYPASS0.u32)) + u32Data * PQ_VID_OFFSET));
    if (u32Bypass)
    {
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_SMMU_BYPASS0.u32)) + u32Data * PQ_VID_OFFSET), V0_SMMU_BYPASS0.u32);
...
static HI_S32 PQ_HAL_SetVdpDbmCfgAddr(HI_U32 u32Data, HI_U32 u32Addr)
{
    ...
    V0_DBM_CFGAD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_DBM_CFGAD.u32)) + u32Data * PQ_VP_OFFSET));
    V0_DBM_CFGAD.bits.coef_addr = u32Addr;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_DBM_CFGAD.u32)) + u32Data * PQ_VP_OFFSET), V0_DBM_CFGAD.u32);
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_InitVdpDbm(HI_VOID)
{
    ...
    memcpy((HI_U32*)(g_stIPSelAlgBuffer.pu8StartVirAddr + u32DbAddrOffset), (HI_U32*) & (pstVirReg->VPSS_DB_CTRL), u32DbParaSize + 128 * 4);
...
HI_S32 PQ_HAL_SetSttWbcAddr(HI_U32 u32Data, HI_U32 u32YAddr)
{
    ...
    pstVDPReg = PQ_HAL_GetVdpReg();
    WBC_ME_CADDR.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_CADDR.u32)) + u32Data * PQ_VID_OFFSET));
    WBC_ME_CADDR.bits.wbccaddr = u32YAddr;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_CADDR.u32)) + u32Data * PQ_VID_OFFSET), WBC_ME_CADDR.u32);
...
HI_S32 PQ_HAL_SetMadWbcRegUp(HI_U32 u32Data)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->WBC_ME_UPD.u32)) + u32Data * PQ_VID_OFFSET), WBC_ME_UPD.u32);
...
HI_S32  PQ_HAL_SetDbmInfoReso(HI_U32 u32Data, HI_U32 u32InfoWidth, HI_U32 u32InfoHeight)
{
    ...
    V0_DBM_RESO.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVDPReg->V0_DBM_RESO.u32)) + u32Data * PQ_VID_OFFSET));
    V0_DBM_RESO.bits.info_width   = u32InfoWidth - 1;
    V0_DBM_RESO.bits.info_height  = u32InfoHeight - 1;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVDPReg->V0_DBM_RESO.u32)) + u32Data * PQ_VID_OFFSET), V0_DBM_RESO.u32);
