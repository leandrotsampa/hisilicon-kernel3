...
static HI_VOID PQ_HAL_SetDCICoefAddr(PQ_HAL_LAYER_VID_E u32ChId, HI_U32 u32CoefAddr)
{
    ...
    V0_DCICOEFAD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->V0_DCICOEFAD.u32)) + u32ChId * PQ_VID_OFFSET));
    V0_DCICOEFAD.bits.dci_coef_addr = u32CoefAddr;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->V0_DCICOEFAD.u32)) + u32ChId * PQ_VID_OFFSET), V0_DCICOEFAD.u32);
    return;
}
...
HI_VOID PQ_HAL_UpdateDCICoef(PQ_HAL_LAYER_VID_E u32ChId)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    V0_PARAUP.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->V0_PARAUP.u32)) + u32ChId * PQ_VID_OFFSET));
    V0_PARAUP.bits.v0_dcicoef_upd = 1;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->V0_PARAUP.u32)) + u32ChId * PQ_VID_OFFSET), V0_PARAUP.u32);
    return;
}
...
HI_VOID PQ_HAL_SetDCIDemoMode(PQ_HAL_LAYER_VID_E u32ChId, DCI_DEMO_MODE_E enMode)
{
    ...
    VP0_DCICTRL.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCICTRL.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCICTRL.bits.dci_dbg_mode = enMode;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCICTRL.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCICTRL.u32);
...
HI_VOID PQ_HAL_EnableDciBS(PQ_HAL_LAYER_VID_E u32ChId, HI_BOOL bOnOff)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCI_BLACK0_STRETCH.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_BLACK0_STRETCH.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCI_BLACK0_STRETCH.bits.dci_bs_en = bOnOff;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_BLACK0_STRETCH.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCI_BLACK0_STRETCH.u32);
...
HI_VOID PQ_HAL_GetDCIlevel(PQ_HAL_LAYER_VID_E u32ChId, HI_U16* pu16Gain0, HI_U16* pu16Gain1, HI_U16* pu16Gain2)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCIGLBGAIN.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIGLBGAIN.u32)) + u32ChId * PQ_VID_OFFSET));
...
HI_VOID PQ_HAL_SetDCIlevel(PQ_HAL_LAYER_VID_E u32ChId, HI_U16 u16Gain0, HI_U16 u16Gain1, HI_U16 u16Gain2)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIGLBGAIN.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIGLBGAIN.u32);
...
HI_VOID PQ_HAL_SetDCIWindow(PQ_HAL_LAYER_VID_E u32ChId, HI_U16 u16HStar, HI_U16 u16HEnd, HI_U16 u16VStar, HI_U16 u16VEnd)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCIHPOS.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIHPOS.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCIHPOS.bits.dci_hstart = u16HStar;
    VP0_DCIHPOS.bits.dci_hend   = u16HEnd;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIHPOS.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIHPOS.u32);

    VP0_DCIVPOS.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIVPOS.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCIVPOS.bits.dci_vstart = u16VStar;
    VP0_DCIVPOS.bits.dci_vend   = u16VEnd;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIVPOS.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIVPOS.u32);

    VP0_DCI_OUT_HREGION.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_OUT_HREGION.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCI_OUT_HREGION.bits.dci_out_hstart = u16HStar;
    VP0_DCI_OUT_HREGION.bits.dci_out_hend   = u16HEnd;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_OUT_HREGION.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIHPOS.u32);

    VP0_DCI_OUT_VREGION.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_OUT_VREGION.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCI_OUT_VREGION.bits.dci_out_vstart = u16VStar;
    VP0_DCI_OUT_VREGION.bits.dci_out_vend   = u16VEnd;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_OUT_VREGION.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIVPOS.u32);
...
HI_S32 PQ_HAL_GetDCIHistgram(DCI_HISTGRAM_S* pstDciHist)
{
    ...
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_PARARD.u32))), VP0_DCI_PARARD.u32);
    ...
    /* 直方图读使能关闭 */
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCI_PARARD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_PARARD.u32))));
...
HI_S32 PQ_HAL_SetDCIDemoPos(PQ_HAL_LAYER_VID_E u32ChId, HI_U32 u32Pos)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCIHISOFT.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIHISOFT.u32)) + u32ChId * PQ_VID_OFFSET));
    VP0_DCIHISOFT.bits.dci_dbg_pos = u32Pos;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIHISOFT.u32)) + u32ChId * PQ_VID_OFFSET), VP0_DCIHISOFT.u32);
...
HI_S32 PQ_HAL_SetDciAlphaBlend(PQ_HAL_LAYER_VID_E u32VId, HI_U32 u32AlphaBlend)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCIMERBLD.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIMERBLD.u32)) + u32VId * PQ_VID_OFFSET));
    VP0_DCIMERBLD.bits.dci_org_abld = u32AlphaBlend;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCIMERBLD.u32)) + u32VId * PQ_VID_OFFSET), VP0_DCIMERBLD.u32);
...
HI_S32 PQ_HAL_SetDciClipLimit(PQ_HAL_LAYER_VID_E u32VId, HI_U32 u32ClipLimitR, HI_U32 u32ClipLimitL)
{
    ...
    pstVdpReg = PQ_HAL_GetVdpReg();
    VP0_DCI_HIST_CLIP.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_HIST_CLIP.u32)) + u32VId * PQ_VID_OFFSET));
    VP0_DCI_HIST_CLIP.bits.dci_clip_limit_r = u32ClipLimitR;
    VP0_DCI_HIST_CLIP.bits.dci_clip_limit_l = u32ClipLimitL;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_HIST_CLIP.u32)) + u32VId * PQ_VID_OFFSET), VP0_DCI_HIST_CLIP.u32);
...
HI_S32 PQ_HAL_SetDciManAlgBlendEn(PQ_HAL_LAYER_VID_E u32VId, HI_BOOL bEn)
{
    ...
    VP0_DCI_SPLIT.u32 = PQ_HAL_RegRead((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_SPLIT.u32)) + u32VId * PQ_VID_OFFSET));
    VP0_DCI_SPLIT.bits.dci_man_alg_blend_en = bEn;
    PQ_HAL_RegWrite((HI_U32*)((unsigned long)(&(pstVdpReg->VP0_DCI_SPLIT.u32)) + u32VId * PQ_VID_OFFSET), VP0_DCI_SPLIT.u32);
