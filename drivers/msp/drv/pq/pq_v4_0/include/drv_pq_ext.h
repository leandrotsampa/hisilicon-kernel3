...
{
    HI_DRV_VIDEO_FRAME_TYPE_E enSrcFrameType; /* SDR/HDR10/BBC...*/
    HI_DRV_VIDEO_HDR10_INFO_S stHdr10Info;    /* HDR10 metadata info */
...
typedef struct tagPQ_EXPORT_FUNC_S
{
    ...
    FN_PQ_GetWcgGmmCoef           pfnPQ_GetWcgGmmCoef;
    FN_PQ_GetWcgDeGmmCoef         pfnPQ_GetWcgDeGmmCoef;
    FN_PQ_GetGfxWcgGmmCoef        pfnPQ_GetGfxWcgGmmCoef;
    FN_PQ_GetGfxWcgDeGmmCoef      pfnPQ_GetGfxWcgDeGmmCoef;
} PQ_EXPORT_FUNC_S;
