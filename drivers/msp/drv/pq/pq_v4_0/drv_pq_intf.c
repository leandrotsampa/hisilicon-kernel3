...
#endif
#ifdef PQ_ALG_CSC
        case HIIOC_PQ_S_GAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;

            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_SetWcgGmmCoef(pstAttr);

            break;
        }
        case HIIOC_PQ_G_GAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;
            HI_U32 u32Layer = 0;
            HI_U32 u32GamPre;
            ...
            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_GetWcgGmmCoef(u32Layer, pstAttr, &u32GamPre);

            break;
        }
        case HIIOC_PQ_S_DEGAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;

            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_SetWcgDeGmmCoef(pstAttr);

            break;
        }
        case HIIOC_PQ_G_DEGAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;
            HI_U32 u32Layer = 0;
            HI_U32 u32DeGamPre;
            ...
            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_GetWcgDeGmmCoef(u32Layer, pstAttr, &u32DeGamPre);

            break;
        }
#endif
#ifdef PQ_ALG_GFXCSC
        case HIIOC_PQ_S_GFX_GAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;

            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_SetGfxWcgGmmCoef(pstAttr);

            break;
        }
        case HIIOC_PQ_G_GFX_GAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;
            HI_U32 u32Layer = 0;
            HI_U32 u32GamPre;
            ...
            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_GetGfxWcgGmmCoef(u32Layer, pstAttr, &u32GamPre);

            break;
        }
        case HIIOC_PQ_S_GFX_DEGAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;

            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_SetGfxWcgDeGmmCoef(pstAttr);

            break;
        }
        case HIIOC_PQ_G_GFX_DEGAMM_PARA:
        {
            HI_PQ_GAMM_PARA_S* pstAttr;
            HI_U32 u32Layer = 0;
            HI_U32 u32DeGamPre;
            ...
            pstAttr = (HI_PQ_GAMM_PARA_S*)arg;
            s32Ret = PQ_MNG_GetGfxWcgDeGmmCoef(u32Layer, pstAttr, &u32DeGamPre);
