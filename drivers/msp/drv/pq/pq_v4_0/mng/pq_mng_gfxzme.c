...
static HI_VOID PQ_MNG_GZmeComnSet(HI_PQ_GFX_ZME_PARA_S* pstZmeDrvPara, PQ_GZME_RTL_PARA_S* pstZmeRtlPara)
{
    ...
    */
    ...
    {
        pstZmeRtlPara->bZmeOrder = PQ_GZME_ORDER_VH; //Ver First
    }
    else if ((pstZmeDrvPara->u32ZmeFrmWOut <= 1920) && (pstZmeDrvPara->u32ZmeFrmWIn > 1920))
    {
        pstZmeRtlPara->bZmeOrder = PQ_GZME_ORDER_HV; //Hor First
    }
    else
    {
        pstZmeRtlPara->bZmeOrder = PQ_GZME_ORDER_VH; //Ver First
    ...
    {
        pstZmeRtlPara->bZmeTapV  = PQ_GZME_VER_TAP_4;//Ver 4Tap
    }
    else
    {
        if ((pstZmeDrvPara->u32ZmeFrmWOut <= 1920) && (pstZmeDrvPara->u32ZmeFrmWIn <= 1920))
        ...
        {
            pstZmeRtlPara->bZmeTapV  = PQ_GZME_VER_TAP_2;//Ver 2Tap
        }
        else if ((pstZmeDrvPara->u32ZmeFrmWOut > 1920) && (pstZmeDrvPara->u32ZmeFrmWIn <= 1920))
        {
            pstZmeRtlPara->bZmeTapV  = PQ_GZME_VER_TAP_4;//Ver 4Tap
...
static HI_U32 PQ_MNG_GetGfxHLfirCoef(PQ_GZME_COEF_ADDR_S* pstZmeCoefAddr, HI_U32 u32Ratio)
{
    ...
    else if (u32TmpRatio >= 3482) { u32CoefAddr = pstZmeCoefAddr->u32ZmeCoefAddrHL_E1;  }
...
static HI_U32 PQ_MNG_GetGfxHCfirCoef(PQ_GZME_COEF_ADDR_S* pstZmeCoefAddr, HI_U32 u32Ratio)
{
    ...
    else if (u32TmpRatio >= 3482) { u32CoefAddr = pstZmeCoefAddr->u32ZmeCoefAddrHC_E1;  }
...
static HI_U32 PQ_MNG_GetGfxVLfirCoef(PQ_GZME_COEF_ADDR_S* pstZmeCoefAddr, HI_U32 u32Ratio)
{
    ...
    else if (u32TmpRatio >= 3482) { u32CoefAddr = pstZmeCoefAddr->u32ZmeCoefAddrVL_E1;  }
...
static HI_U32 PQ_MNG_GetGfxVCfirCoef(PQ_GZME_COEF_ADDR_S* pstZmeCoefAddr, HI_U32 u32Ratio)
{
    ...
    else if (u32TmpRatio >= 3482) { u32CoefAddr = pstZmeCoefAddr->u32ZmeCoefAddrVC_E1;  }
