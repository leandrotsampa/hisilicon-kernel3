...
typedef struct
{
    ...
    /* add by z241841 2015.7.25 */
    HI_U32 ImgGlobalAdjustEn;

    //HI_S32 s32LumVBlkDetNum;
    //HI_S32 s32ChrHBlkDetNum;

    //HI_S32 s32LumVBlkSize;      /* non-interface register [6,64] */
    //HI_S32 s32ChrHBlkSize;      /* non-interface register [6,64] */
    //DM_REG_S*  pDmReg;
} DM_INF_S;
