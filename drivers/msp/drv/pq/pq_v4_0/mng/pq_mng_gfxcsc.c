...
#ifndef HI_BUILD_IN_BOOT
HI_U16 g_au1GfxGammCoef[1024] =
{
    0,
};

HI_U16 g_au16GfxDeGammCoef[1024] =
{
    0,
};
#endif
...
static HI_U32       u32CscScalePre = 10;
...
{
    HI_S32 tmpBright = 0, tmpContrst = 0;

    tmpBright  = (HI_S32)stGfxCscTuning.u32Bright - 50;
    tmpContrst = (HI_S32)stGfxCscTuning.u32Contrst;
    ...
    if (pstGfxCscMode->stGfxCscInputCs.eCsType >= PQ_GFX_CS_eYCbCr_709 && pstGfxCscMode->stGfxCscInputCs.eCsType <= PQ_GFX_CS_eYCbCr_2020) /* input YUV color space */
    {
        if (pstGfxCscMode->stGfxCscOutputCs.eCsType >= PQ_GFX_CS_eYCbCr_709 && pstGfxCscMode->stGfxCscOutputCs.eCsType <= PQ_GFX_CS_eYCbCr_2020) /* YUV->YUV */
        {
    ...
    {
        if (pstGfxCscMode->stGfxCscOutputCs.eCsType >= PQ_GFX_CS_eYCbCr_709 && pstGfxCscMode->stGfxCscOutputCs.eCsType <= PQ_GFX_CS_eYCbCr_601) /* RGB->YUV */
        {
            switch (pstGfxCscMode->stGfxCscInputCs.eCsRange) /* input DC */
            {
...
{
    PQ_GFX_CS_TYPE_E  eGfxInputType,  eGfxOutputType;
    PQ_GFX_CS_RANGE_E eGfxInputRange, eGfxOutputRange;
    eGfxInputRange  = pstCscMode->stGfxCscInputCs.eCsRange;
    eGfxOutputRange = pstCscMode->stGfxCscOutputCs.eCsRange;
    eGfxInputType   = pstCscMode->stGfxCscInputCs.eCsType;
    eGfxOutputType  = pstCscMode->stGfxCscOutputCs.eCsType;
...
HI_S32 PQ_MNG_GetGfxCscCoef(HI_PQ_CSC_CRTL_S* pstCscCtrl, HI_PQ_GFX_CSC_MODE_S* pstGfxCscPara, PQ_GFX_CSC_COEF_S* pstCscCoef, PQ_GFX_CSC_DCCOEF_S* pstCscDcCoef)
{
    ...
    if (HI_PQ_CSC_NORMAL_SETTING == pstCscCtrl->enCscType) /* It does not be tuned */
    {
        ...
        {
            PQ_MNG_CalcWcgDc    (&stGfxCscMode, &stPQGfxCscDcCoef);
            PQ_MNG_CalcWcgMatrix(&stGfxCscMode, &stPQGfxCscCoef);
        }
        else /* Not About 2020 */
        {
            PQ_MNG_CalcCscDc    (&stGfxCscMode, &stPQGfxCscDcCoef);
            PQ_MNG_CalcCscMatrix(&stGfxCscMode, &stPQGfxCscCoef, bIsBGRIn);
        }
    }
    ...
    {
        u32CscScalePre = 1 << (pstCscCtrl->u32CscPre - 10);

        pstCscCoef->csc_coef00 = (HI_S32)(stPQGfxCscCoef.csc_coef00 * u32CscScalePre / 2);
        pstCscCoef->csc_coef01 = (HI_S32)(stPQGfxCscCoef.csc_coef01 * u32CscScalePre / 2);
        pstCscCoef->csc_coef02 = (HI_S32)(stPQGfxCscCoef.csc_coef02 * u32CscScalePre / 2);
        pstCscCoef->csc_coef10 = (HI_S32)(stPQGfxCscCoef.csc_coef10 * u32CscScalePre / 2);
        pstCscCoef->csc_coef11 = (HI_S32)(stPQGfxCscCoef.csc_coef11 * u32CscScalePre / 2);
        pstCscCoef->csc_coef12 = (HI_S32)(stPQGfxCscCoef.csc_coef12 * u32CscScalePre / 2);
        pstCscCoef->csc_coef20 = (HI_S32)(stPQGfxCscCoef.csc_coef20 * u32CscScalePre / 2);
        pstCscCoef->csc_coef21 = (HI_S32)(stPQGfxCscCoef.csc_coef21 * u32CscScalePre / 2);
        pstCscCoef->csc_coef22 = (HI_S32)(stPQGfxCscCoef.csc_coef22 * u32CscScalePre / 2);

        pstCscDcCoef->csc_in_dc0  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc0  * u32CscScalePre);
        pstCscDcCoef->csc_in_dc1  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc1  * u32CscScalePre);
        pstCscDcCoef->csc_in_dc2  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc2  * u32CscScalePre);
        pstCscDcCoef->csc_out_dc0 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc0 * u32CscScalePre);
        pstCscDcCoef->csc_out_dc1 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc1 * u32CscScalePre);
        pstCscDcCoef->csc_out_dc2 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc2 * u32CscScalePre);

    }
    else
    {
        pstCscCoef->csc_coef00 = (HI_S32)(stPQGfxCscCoef.csc_coef00);
        pstCscCoef->csc_coef01 = (HI_S32)(stPQGfxCscCoef.csc_coef01);
        pstCscCoef->csc_coef02 = (HI_S32)(stPQGfxCscCoef.csc_coef02);
        pstCscCoef->csc_coef10 = (HI_S32)(stPQGfxCscCoef.csc_coef10);
        pstCscCoef->csc_coef11 = (HI_S32)(stPQGfxCscCoef.csc_coef11);
        pstCscCoef->csc_coef12 = (HI_S32)(stPQGfxCscCoef.csc_coef12);
        pstCscCoef->csc_coef20 = (HI_S32)(stPQGfxCscCoef.csc_coef20);
        pstCscCoef->csc_coef21 = (HI_S32)(stPQGfxCscCoef.csc_coef21);
        pstCscCoef->csc_coef22 = (HI_S32)(stPQGfxCscCoef.csc_coef22);

        pstCscDcCoef->csc_in_dc0  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc0);
        pstCscDcCoef->csc_in_dc1  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc1);
        pstCscDcCoef->csc_in_dc2  = (HI_S32)(stPQGfxCscDcCoef.csc_in_dc2);
        pstCscDcCoef->csc_out_dc0 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc0);
        pstCscDcCoef->csc_out_dc1 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc1);
        pstCscDcCoef->csc_out_dc2 = (HI_S32)(stPQGfxCscDcCoef.csc_out_dc2);
    }
...
HI_S32 PQ_MNG_SetGfxCscCoef(HI_PQ_GFX_LAYER_E enGfxCscLayer, HI_PQ_GFX_CSC_MODE_S* pstGfxCscMode)
{
    ...
    if (PQ_GFX_GP0 == enGfxCscLayer)
    {
                 ...
                 && (PQ_GFX_CS_BT709_YUV_LIMITED == pstGfxCscMode->eOutputCS))
        {
            stCscCtrl.bCSCEn       = HI_TRUE;
            stCscCtrl.u32CscPre    = 15;
            stCscCtrl.enCscType    = HI_PQ_CSC_TUNING_GP0;
            stGfxCscPara.eInputCS  = PQ_GFX_CS_BT709_RGB_FULL;
...
HI_S32 PQ_MNG_DeInitGfxCSC(HI_VOID)
{
    ...
    s32Ret = PQ_HAL_GfxBT2020DeInit();
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_PQ("BT2020 HAL DeInit error!\n");
        return HI_FAILURE;
    }
...
{
    if (HI_NULL == pstGmmCoef)
    {
        return HI_FAILURE;
    }

    memcpy(g_au1GfxGammCoef, pstGmmCoef->u16GammCoef, sizeof(g_au1GfxGammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_GetGfxWcgGmmCoef(HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstGmmCoef, HI_U32* pu32GamPre)
{
    if ((HI_NULL == pstGmmCoef) || (HI_NULL == pu32GamPre))
    {
        return HI_FAILURE;
    }

    *pu32GamPre = 10;
    memcpy(pstGmmCoef->u16GammCoef, g_au1GfxGammCoef, sizeof(g_au1GfxGammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_SetGfxWcgDeGmmCoef(HI_PQ_GAMM_PARA_S* pstDeGmmCoef)
{
    if (HI_NULL == pstDeGmmCoef)
    {
        return HI_FAILURE;
    }

    memcpy(g_au16GfxDeGammCoef, pstDeGmmCoef->u16GammCoef, sizeof(g_au16GfxDeGammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_GetGfxWcgDeGmmCoef(HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstDeGmmCoef, HI_U32* pu32DeGamPre)
{
    if ((HI_NULL == pstDeGmmCoef) || (HI_NULL == pu32DeGamPre))
    {
        return HI_FAILURE;
    }

    *pu32DeGamPre = 10;
    memcpy(pstDeGmmCoef->u16GammCoef, g_au16GfxDeGammCoef, sizeof(g_au16GfxDeGammCoef));
    return HI_SUCCESS;
}
...
static stPQAlgFuncs stGfxCSCFuncs =
{
    ...
    .GetGfxWcgGmmCoef         = PQ_MNG_GetGfxWcgGmmCoef,
    .GetGfxWcgDeGmmCoef       = PQ_MNG_GetGfxWcgDeGmmCoef,
};
