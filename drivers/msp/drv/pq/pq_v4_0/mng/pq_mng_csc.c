...
HI_U32 g_u32ColorTempR = 50;
HI_U32 g_u32ColorTempG = 50;
HI_U32 g_u32ColorTempB = 50;


static HI_U32  u32CscScalePre;
...
HI_U16 g_au16GammCoef[1024] =
{
    0,
};

HI_U16 g_au16DeGammCoef[1024] =
{
    0,
};
...
static HI_S32 PQ_MNG_SetCSCPictureParam(HAL_PQ_CSC_TYPE_E enCscTpyeId, CSC_COEF_S* pstCscCoef, CSC_DCCOEF_S* pstCscDcCoef)
{
    ...
    if ((HAL_CSC_TUNING_V0 == enCscTpyeId) || (HAL_CSC_TUNING_V1 == enCscTpyeId))
    {
        ...
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(g_u32ColorTempR);
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(g_u32ColorTempG);
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(g_u32ColorTempB);
        ...
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(g_u32ColorTempR);
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(g_u32ColorTempG);
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(g_u32ColorTempB);
    ...
    else if ((HAL_CSC_TUNING_V3 == enCscTpyeId) || (HAL_CSC_TUNING_V4 == enCscTpyeId))
    {
        ...
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(g_u32ColorTempR);
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(g_u32ColorTempG);
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(g_u32ColorTempB);
        ...
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(g_u32ColorTempR);
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(g_u32ColorTempG);
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(g_u32ColorTempB);
...
HI_S32 PQ_MNG_SetWcgGmmCoef( HI_PQ_GAMM_PARA_S* pstGmmCoef)
{
    PQ_CHECK_NULL_PTR(pstGmmCoef);

    memcpy(g_au16GammCoef, pstGmmCoef->u16GammCoef, sizeof(g_au16GammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_GetWcgGmmCoef(HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstGmmCoef, HI_U32* pu32GamPre)
{
    PQ_CHECK_NULL_PTR(pstGmmCoef);
    PQ_CHECK_NULL_PTR(pu32GamPre);

    *pu32GamPre = 10;
    memcpy(pstGmmCoef->u16GammCoef, g_au16GammCoef, sizeof(g_au16GammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_SetWcgDeGmmCoef(HI_PQ_GAMM_PARA_S* pstDeGmmCoef)
{
    PQ_CHECK_NULL_PTR(pstDeGmmCoef);

    memcpy(g_au16DeGammCoef, pstDeGmmCoef->u16GammCoef, sizeof(g_au16DeGammCoef));
    return HI_SUCCESS;
}

HI_S32 PQ_MNG_GetWcgDeGmmCoef(HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstDeGmmCoef, HI_U32* pu32DeGamPre)
{
    PQ_CHECK_NULL_PTR(pstDeGmmCoef);
    PQ_CHECK_NULL_PTR(pu32DeGamPre);

    *pu32DeGamPre = 10;
    memcpy(pstDeGmmCoef->u16GammCoef, g_au16DeGammCoef, sizeof(g_au16DeGammCoef));
    return HI_SUCCESS;
}
...
static stPQAlgFuncs stCSCFuncs =
{
    ...
    .GetWcgGmmCoef      = PQ_MNG_GetWcgGmmCoef,
    .GetWcgDeGmmCoef    = PQ_MNG_GetWcgDeGmmCoef,
};
