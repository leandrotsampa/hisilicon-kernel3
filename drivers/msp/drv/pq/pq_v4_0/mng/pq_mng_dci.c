...
static HI_S32 PQ_MNG_FindDciGain(HI_VOID)
{
    ...
    PQ_MNG_FindBinPos(HI_PQ_MODULE_DCI, &u32StartPos, &u32EndPos);
...
static HI_S32 PQ_MNG_DciBSLutInit(HI_BOOL bDefault)
{
    ...
    memset(&stDciBsLut, 0, sizeof(DCI_LUT_S));
...
HI_S32 PQ_MNG_InitDCI(PQ_PARAM_S* pstPqParam, HI_BOOL bDefault)
{
    ...
    s32Ret = PQ_MNG_InitPhyList(u32ID, HI_PQ_MODULE_DCI, SOURCE_MODE_HD, OUTPUT_MODE_HD);
...
HI_S32 PQ_MNG_SetDCILevelGain(HI_U32 u32DCILevelGain)
{
    ...
    stDCILevelTmp.u8Gain0 = ALG_CLIP3(0, 63, (sg_u32DCILevelGain[g_u32SourceMode][DCI_GLOBAL_GAIN_0] + s32GainOffset0));
    stDCILevelTmp.u8Gain1 = ALG_CLIP3(0, 63, (sg_u32DCILevelGain[g_u32SourceMode][DCI_GLOBAL_GAIN_1] + s32GainOffset1));
    stDCILevelTmp.u8Gain2 = ALG_CLIP3(0, 63, (sg_u32DCILevelGain[g_u32SourceMode][DCI_GLOBAL_GAIN_2] + s32GainOffset2));

    PQ_HAL_SetDCIlevel(PQ_HAL_LAYER_VID0, stDCILevelTmp.u8Gain0, stDCILevelTmp.u8Gain1, stDCILevelTmp.u8Gain2);

    if (g_u32SourceMode >= SOURCE_MODE_UHD)
    {
