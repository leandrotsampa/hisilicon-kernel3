...
HI_S32 PQ_MNG_InitDeshoot(PQ_PARAM_S* pstPqParam, HI_BOOL bDefault)
{
    ...
    /* single DS */
    s32Ret = PQ_MNG_InitPhyList(u32VID, HI_PQ_MODULE_DS, SOURCE_MODE_HD, OUTPUT_MODE_HD);
...
//HI_S32 PQ_MNG_InitArtDeshoot(PQ_PARAM_S* pstPqParam, HI_BOOL bDefault)
//{
//    HI_S32 s32Ret;
//    HI_U32 u32ID = 0;
//
...
//    s32Ret = PQ_MNG_InitPhyList(u32ID, HI_PQ_MODULE_ARTDS, SOURCE_MODE_HD, OUTPUT_MODE_HD);
//    if (HI_SUCCESS != s32Ret)
//    {
//        HI_ERR_PQ("Deshoot InitPhyList error\n");
//        return HI_FAILURE;
