...
{
    {256, 256, 256, 256}, /* SOURCE_MODE_NO  */
    {256, 256, 256, 256}, /* SOURCE_MODE_SD  */
    {256, 256, 256, 256}, /* SOURCE_MODE_HD  */
    {80, 80, 80,  80}, /* SOURCE_MODE_UHD */
};

static HI_U32 sg_u32Gain2[SOURCE_MODE_ALL][OUTPUT_MODE_ALL] =
{
    {128, 128, 128, 128}, /* SOURCE_MODE_NO  */
    {128, 128, 128, 128}, /* SOURCE_MODE_SD  */
    {128, 128, 128, 128}, /* SOURCE_MODE_HD  */
    {40, 40, 40, 40}, /* SOURCE_MODE_UHD */
};
...
static HI_S32 PQ_MNG_FindSharpenGainRatio(HI_U32 ppu32Gain[][4], HI_U32 u32RegAddr, HI_U8 u8GainLsb, HI_U8 u8GainMsb)
{
    ...
    PQ_MNG_FindBinPos(HI_PQ_MODULE_SHARPNESS, &u32StartPos, &u32EndPos);
...
HI_S32 PQ_MNG_InitSharpen(PQ_PARAM_S* pstPqParam, HI_BOOL bDefault)
{
    ...
    s32Ret = PQ_MNG_InitPhyList(u32Data, HI_PQ_MODULE_SHARPNESS, SOURCE_MODE_HD, OUTPUT_MODE_NO);
...
HI_S32 PQ_MNG_SetSharpenStr(HI_U32 u32ShpStr)
{
    ...
    stSharpGain.u32PeakGain = sg_u32Gain1[g_u32SourceMode][OUTPUT_MODE_NO];
    stSharpGain.u32EdgeGain = sg_u32Gain2[g_u32SourceMode][OUTPUT_MODE_NO];
