...
/* 肤色增益控制 */
HI_S32 PQ_MNG_SetFleshToneLevel(HI_PQ_FLESHTONE_E enGainLevel, HI_U32 u32SourceMode);
/* 六基色控制设置 */
HI_S32 PQ_MNG_SetSixBaseColorLevel(HI_PQ_SIX_BASE_S* pstSixBaseColorOffset, HI_U32 u32SourceMode);
/* 获取六基色设置值 */
...
HI_S32 PQ_MNG_GetACMDemoMode(PQ_DEMO_MODE_E* enMode);
/* 打开ACM模块 */
...
HI_S32 PQ_MNG_SetColorEnhanceMode(HI_PQ_COLOR_SPEC_MODE_E  enColorSpecMode, HI_U32 u32SourceMode);
#endif
