...
typedef struct hiPQ_ALG_FUNCS_S
{
    ...
    HI_S32 (*GetWcgGmmCoef)      (HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstGmmCoef, HI_U32* pu32GamPre);
    HI_S32 (*GetWcgDeGmmCoef)    (HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstDeGmmCoef, HI_U32* pu32DeGamPre);
    /*GFX CSC*/
    ...
    HI_S32 (*GetGfxWcgGmmCoef)        (HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstGmmCoef, HI_U32* pu32GamPre);
    HI_S32 (*GetGfxWcgDeGmmCoef)      (HI_U32 u32Layer, HI_PQ_GAMM_PARA_S* pstDeGmmCoef, HI_U32* pu32DeGamPre);
    /*ZME*/
    ...
    HI_S32 (*CheckZme2L)        (HI_U32 u32InWitdh, HI_U32 u32InHeigh, HI_PQ_ZME_WIN_S stZmeWin, HI_U32* pu32OutWitdh, HI_U32* pu32OutHeigh);
	...
	HI_S32 (*SetHdrCfg) (HI_BOOL bDefault);
} stPQAlgFuncs;
...
extern HI_U32   g_u32SourceMode;
extern HI_U32   g_u32OutputMode;
