...
#if defined(DMX_DESCRAMBLER_TYPE_AES_CBC_OBSOLETE_SUPPORT) && !defined(DMX_DESCRAMBLER_TYPE_SPE_V2_SUPPORT)
#error "DMX_DESCRAMBLER_TYPE_AES_CBC_OBSOLETE_SUPPORT depend on DMX_DESCRAMBLER_TYPE_SPE_V2_SUPPORT."
#endif
...
#elif defined(DMX_DESCRAMBLER_TYPE_AES_CBC_OBSOLETE_SUPPORT)
            /* same action as HI_UNF_DMX_DESCRAMBLER_TYPE_AES_CI + IV=0 . */
            if (CaInfo.bits.dis_spe)
            {
                HI_WARN_DEMUX("disable SPE\n");
