...
/*=============================================CHIP_TYPE_hi3798cv200_a=========================================*/
#elif defined(CHIP_TYPE_hi3798cv200_a)
#define DMX_CLUSTER_TOTAL_SET_CNT    2
...
#define DMX_SET_2                       2
#define DMX_SET_2_INT_NUM         (32 + 83)
#define DMX_SET_2_BASE               (0xF9C10000)  
...
#define DMX_IFPORT_CNT                  1
#define DMX_TSIPORT_CNT                12
#define DMX_TSOPORT_CNT               1  /* only dmx_set_1 export TSO port */
#define DMX_TUNERPORT_CNT            (DMX_IFPORT_CNT + DMX_TSIPORT_CNT)
#define DMX_RAMPORT_CNT               4
#define DMX_TAGPORT_CNT                0
...
#define DMX_DESCRAMBLER_TYPE_AES_CBC_OBSOLETE_SUPPORT
#define DMX_DESCRAMBLER_TYPE_DES_SUPPORT
#define DMX_DESCRAMBLER_TYPE_AES_NS_SUPPORT
#define DMX_DESCRAMBLER_TYPE_SMS4_NS_SUPPORT
#define DMX_DESCRAMBLER_TYPE_SMS4_IPTV_SUPPORT
