...
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420) || defined(CHIP_TYPE_hi3798cv200_a) || defined(CHIP_TYPE_hi3798cv200_b) || defined(CHIP_TYPE_hi3798cv200)
/*
...
/*for 3751v100 (S5), we have 2 inside QAM port， so , TSI port ID begin from 2 in driver code*/
        ...
        case 8:
            PeriCrg63.bits.pvr_tsi9_pctrl = Pol;    
            break;
            
        case 9:
            PeriCrg63.bits.pvr_tsi10_pctrl = Pol;    
            break;
            
        case 10:
            PeriCrg63.bits.pvr_tsi11_pctrl = Pol;    
            break;
            
        case 11:
            PeriCrg63.bits.pvr_tsi12_pctrl = Pol;    
            break;
            
        case 12:
            PeriCrg63.bits.pvr_tsi13_pctrl = Pol;    
            break;
#endif            
        default:
            WARN(1, "%s: Invalid TSI Port ID(%d).\n", __func__, RawPortId);
...
HI_VOID DmxHalGetChannelDescrambleFlag(Dmx_Set_S *DmxSet, HI_U32 ChanId, HI_BOOL *pEnable)
{
    U_DMX_PID_CTRL dmx_pidctrl;
    ...
    dmx_pidctrl.u32 = DMX_READ_REG(DmxSet->IoBase, DMX_PID_CTRL(ChanId));
    *pEnable = dmx_pidctrl.bits.do_scram & 0x1;
}
...
#if defined(CHIP_TYPE_hi3716cv200) || defined(CHIP_TYPE_hi3716mv400) || defined(CHIP_TYPE_hi3719cv100)
...
HI_VOID DmxHalConfigHardware(HI_VOID)
{
    ...
    PeriCrg63.bits.pvr_tsout0_cken  = 1;
    PeriCrg63.bits.pvr_tsout1_cken  = 1;
    PeriCrg63.bits.pvr_tsi4_cksel   = 0;
    PeriCrg63.bits.pvr_srst_req     = 0;
    ...
    PeriCrg64.bits.pvr_ts0_clk_sel  = 1;
    PeriCrg64.bits.pvr_ts1_clk_sel  = 1;
    PeriCrg64.bits.pvr_ts0_clk_div  = 0;
    PeriCrg64.bits.pvr_ts1_clk_div  = 0;
...
HI_VOID DmxHalConfigHardware(HI_VOID)
{
    ...
    PeriCrg63.bits.pvr_tsi7_cken    = 1;
    PeriCrg63.bits.pvr_tsi8_cken    = 1;
    PeriCrg63.bits.pvr_tsi9_cken    = 1;
    PeriCrg63.bits.pvr_tsi10_cken    = 1;
    PeriCrg63.bits.pvr_tsi11_cken    = 1;
    PeriCrg63.bits.pvr_tsi12_cken    = 1;
#endif    
    PeriCrg63.bits.pvr_ts0_cken     = 1;
    PeriCrg63.bits.pvr_srst_req     = 0;
