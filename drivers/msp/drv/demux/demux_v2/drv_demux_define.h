...
#define TEEC_CMD_LOCK_CHANNEL           4
#define TEEC_CMD_UNLOCK_CHANNEL         5
#define TEEC_CMD_REGISTER_VID_SECBUF    6
#define TEEC_CMD_UNREGISTER_VID_SECBUF  7
#define TEEC_CMD_REGISTER_AUD_SECBUF    8
#define TEEC_CMD_UNREGISTER_AUD_SECBUF  9
#define TEEC_CMD_REGISTER_REC_SECBUF    10
#define TEEC_CMD_UNREGISTER_REC_SECBUF  11
#define TEEC_CMD_PARSER_PES_HEADER      12
#define TEEC_CMD_GET_DISP_CONTROL       13
#define TEEC_CMD_GET_PES_HEADER_LEN     14
#define TEEC_CMD_FIXUP_AUD_SEC_BUF      15
#define TEEC_CMD_VERIFY_HEVC_IDX_DATA   16
#define TEEC_CMD_DUP_HEVC_IDX_DATA      17
