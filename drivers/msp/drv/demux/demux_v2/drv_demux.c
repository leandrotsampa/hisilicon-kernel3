 ...
 */
HI_S32 HI_DRV_DMX_CreateTSBuffer(const HI_U32 PortId, const HI_U32 Size, DMX_MMZ_BUF_S *TsBuf, const HI_VOID *file)
{
    CHECKPOINTER(TsBuf);

    return DMX_OsiTsBufferCreate(PortId, Size, TsBuf);
}
