...
static HI_CHAR s_version[] __attribute__((used)) = "SDK_VERSION:["MKMARCOTOSTR(SDK_VERSION)"] Build Time:["__DATE__", "__TIME__"]";
HI_CHAR g_version[128] = "COMPONENT_VERSION:[Mp3 Decoder with Android OpenSource], Build Time:["__DATE__"__"__TIME__"]";
