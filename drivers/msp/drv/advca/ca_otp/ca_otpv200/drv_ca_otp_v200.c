...
HI_U16 DRV_CA_OTP_CalculateCRC16 (const HI_U8 *pu8Data, HI_U32 u32DataLen)
{
...
HI_U16 DRV_CA_OTP_CalculateRSACRC16(const HI_U8 *pu8Data)
{
    HI_U16 crc_value = 0;
    HI_S32 index     = 0;
...
HI_S32 DRV_CA_OTP_V200_GetECFlag(HI_BOOL *pbEnECFlag)
{
    ...
    u32IdWord1 = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_ID_WORD_1);
    u32IdWord2 = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_ID_WORD_2);
    u32IdWord3 = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_ID_WORD_3);
    u32IdWord4 = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_ID_WORD_4);

    if ((SECURE_CHIP_ID_WORD_1 == (u32IdWord1 & SECURE_CHIP_ID_WORD_1_MASK)) && (SECURE_CHIP_ID_WORD_2 == u32IdWord2) &&
        (SECURE_CHIP_ID_WORD_3 == u32IdWord3) && (SECURE_CHIP_ID_WORD_4 == u32IdWord4))
    {
        *pbEnECFlag = HI_TRUE;
    }
    else
...
HI_S32 DRV_CA_OTP_V200_SetBootMode(CA_OTP_FLASH_TYPE_E type)
{
    ...
    PVLOCK_0.u32 = 0;
    PVLOCK_1.u32 = 0;
#if defined (CHIP_TYPE_hi3716mv420) || defined (CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3798cv200)
...
HI_S32 DRV_CA_OTP_V200_SetJtagProtectMode(CA_OTP_JTAG_MODE_E JtagMode)
{
    ...
    if (OneWay_0.bits.jtag_prt_mode_1)
    {
    ...
    if (OneWay_0.bits.jtag_prt_mode_0)
    {
    ...
    switch (JtagMode)
    {
        ...
        {
            ret = (g_pOTPExportFunctionList->HAL_OTP_V200_WriteByte)(CA_OTP_V200_INTERNAL_JTAG_MODE_BAK, JTAG_MODE_BAK_OPEN);
            if (HI_SUCCESS != ret)
            {
                HI_ERR_CA("Fail to write jtag_mod_bak!\n");
                return ret;
            }
            break;
        }
        case CA_OTP_JTAG_MODE_PROTECT :
        {
            ...
            ret = (g_pOTPExportFunctionList->HAL_OTP_V200_WriteByte)(CA_OTP_V200_INTERNAL_JTAG_MODE_BAK, JTAG_MODE_BAK_PROTECT);
            if (HI_SUCCESS != ret)
            {
                HI_ERR_CA("Fail to write OTP jtag_mod_bak!\n");
                return ret;
            }
            break;
        }
        case CA_OTP_JTAG_MODE_CLOSED:
        {
            ...
            ret = (g_pOTPExportFunctionList->HAL_OTP_V200_WriteByte)(CA_OTP_V200_INTERNAL_JTAG_MODE_BAK, JTAG_MODE_BAK_CLOSE);
            if (HI_SUCCESS != ret)
            {
                HI_ERR_CA("Fail to write OTP jtag_mod_bak!\n");
                return ret;
...
HI_S32 DRV_CA_OTP_V200_GetOTPTzData(CA_OTP_TZ_DATA_S *pstInputParam)
{
    ...
    HI_U32 u32Addr = 0;
    HI_U32 u32Len = 0;
    HI_U8 *pu8ReadBuf = pstInputParam->u8Buf;
    ...
    switch(pstOtpAttr->enOtpFuseId)
    {
	   ...
	   case HI_UNF_ADVCA_OTP_CHIP_ID:
	       ...
	       else
	       {
	           ...
	           memset(u8TmpBuf, 0x0, sizeof(u8TmpBuf));
