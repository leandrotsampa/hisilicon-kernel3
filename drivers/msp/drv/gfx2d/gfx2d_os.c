...
long GFX2D_OS_Ioctl(struct file  *ffile, unsigned int  cmd, unsigned long arg)
{
    ...
    switch(cmd)
    {
        case GFX2D_COMPOSE:
        {
            ...
            memset(&stCompose,0x0,sizeof(GFX2D_COMPOSE_CMD_S));
            memset(&stHalCompose,0x0,sizeof(GFX2D_COMPOSE_CMD_HAL_S));
            ...
            s32Ret = GFX2D_CTL_Compose(stHalCompose.enDevId, &stHalCompose.stComposeList, stHalCompose.pstDst, stHalCompose.bSync, stHalCompose.u32Timeout, NULL, NULL);
