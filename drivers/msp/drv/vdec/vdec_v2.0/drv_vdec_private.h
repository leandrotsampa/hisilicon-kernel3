...
/* VDEC VERSION */
#define VDEC_VERSION                (2016031100)
...
typedef struct tagVDEC_CHANNEL_S
{
    ...
    //VDEC_SPECIAL_FRM_INFO_S specialFrmInfo[VFMW_MAX_RESERVE_NUM];
    //HI_U32 specialFrameNum;//specialFrameExist;
#else
    HI_U32  specialFramePhyAddr;
    HI_U64  specialFrameVirAddr;
    HI_BOOL specialFrameExist;
    HI_BOOL bSpecialFrameCanRls;
#endif
