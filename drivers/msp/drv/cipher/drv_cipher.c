...
{    
    ...
    if ((u32State >> 2) & 0x01)
    {
        HI_ERR_CIPHER("MMU Error, there is a TLB invalid generated during the translation process.\n");
    }
    if ((u32State >> 1) & 0x01)
    {
...
HI_S32 DRV_CIPHER_Encrypt(CIPHER_DATA_S *pstCIData)
{
    ...
    else
    {
...
#if 0
        memcpy((HI_U8 *)(stCITask.stData2Process.u32DataPkg), (HI_U8 *)stSrcMmzBuf.pu8StartVirAddr, pstCIData->u32DataLength);
        stCITask.stData2Process.u32length = pstCIData->u32DataLength;
        stCITask.stData2Process.bDecrypt = HI_FALSE;
        stCITask.u32CallBackArg = softChnId;
        ...
        memcpy((HI_U8 *)stDestMmzBuf.pu8StartVirAddr, (HI_U8 *)(stCITask.stData2Process.u32DataPkg), pstCIData->u32DataLength);
#else
		while(u32Offset < pstCIData->u32DataLength)
		{
		    memcpy((HI_U8 *)(stCITask.stData2Process.u32DataPkg), (HI_U8 *)stSrcMmzBuf.pu8StartVirAddr + u32Offset, 16);
		    stCITask.stData2Process.u32length = 16;
		    stCITask.stData2Process.bDecrypt = HI_FALSE;
		    stCITask.u32CallBackArg = softChnId;
		    ...
		    memcpy((HI_U8 *)stDestMmzBuf.pu8StartVirAddr + u32Offset, (HI_U8 *)(stCITask.stData2Process.u32DataPkg), 16);
		    u32Offset += 16;
		}
#endif
...
HI_S32 DRV_CIPHER_Decrypt(CIPHER_DATA_S *pstCIData)
{
    ...
    else
    {
...
#if 0
        memcpy((HI_U8 *)(pCITask.stData2Process.u32DataPkg), (HI_U8 *)stSrcMmzBuf.pu8StartVirAddr, pstCIData->u32DataLength);
        pCITask.stData2Process.u32length = pstCIData->u32DataLength;
        pCITask.stData2Process.bDecrypt = HI_TRUE;
        pCITask.u32CallBackArg = softChnId;
        ...
        memcpy((HI_U8 *)stDestMmzBuf.pu8StartVirAddr, (HI_U8 *)(pCITask.stData2Process.u32DataPkg), pstCIData->u32DataLength);
#else
		while(u32Offset < pstCIData->u32DataLength)
		{
		    memcpy((HI_U8 *)(pCITask.stData2Process.u32DataPkg), (HI_U8 *)stSrcMmzBuf.pu8StartVirAddr + u32Offset, 16);
		    ...
		    memcpy((HI_U8 *)stDestMmzBuf.pu8StartVirAddr + u32Offset, (HI_U8 *)(pCITask.stData2Process.u32DataPkg), 16);
		    u32Offset += 16;
		}
#endif
