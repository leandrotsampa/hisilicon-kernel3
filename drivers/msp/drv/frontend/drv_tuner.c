                         ...
                         HI_DemodAttr_S *pstDemodAttr, HI_U32 u32ResetGpioNo)
{
    ...
    || defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420)
        ...
        case HI_UNF_DEMOD_DEV_TYPE_MXL214:
        {
            ...
            break;
			 ...
			 case HI_UNF_DEMOD_DEV_TYPE_GX1132:
				{
					u8ChipReset = 1;
					g_stTunerOps[u32TunerPort].tuner_init = gx1132_init;	
					...
					printk("Demod Select Type = HI_UNF_DEMOD_DEV_TYPE_GX1132\n");
					break;
				}
#endif
        ...
        case HI_UNF_DEMOD_DEV_TYPE_MXL683:
        {
			...
			{
				g_stTunerOps[u32TunerPort].tuner_init = _fc8300_init;
...
HI_S32 tuner_osr_sampledata(PTR_TUNER_SAMPLEDATA_S pstSampleData)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = 0;
...
HI_S32 tuner_ioctl(struct inode *inode, struct file *file, HI_U32 cmd, HI_VOID *arg)
{
    ...
    switch (cmd)
    {
        ...
        case TUNER_SETSATATTR_CMD:
        {
            ...
            g_stTunerOps[pstSatAttr->u32Port].enSigType = HI_UNF_TUNER_SIG_TYPE_SAT;
        ...
        case TUNER_SETTERATTR_CMD:
        {
            ...
            g_stTunerOps[pstTerAttr->u32Port].enSigType = HI_UNF_TUNER_SIG_TYPE_DVB_T2;
        ...
        case TUNER_SETCABATTR_CMD:
        {
            ...
            g_stTunerOps[pstCabAttr->u32Port].enSigType = HI_UNF_TUNER_SIG_TYPE_CAB;
        ...
        case TUNER_SAMPLE_DATA_CMD:
        {
            ...
            s32Ret = tuner_osr_sampledata(pstSampleData);
            break;
        }
    ...
    for ( u32TunerPort = 0; u32TunerPort < TUNER_NUM; u32TunerPort++ )
    {
        ...
        switch (g_stTunerOps[u32TunerPort].enDemodDevType)
        {
            ...
            case HI_UNF_DEMOD_DEV_TYPE_3138:
                if (HI_UNF_TUNER_SIG_TYPE_SAT == stSignalInfo.enSigType)
                {
                    switch (stSignalInfo.unSignalInfo.stSat.enModType)
                    {
                        ...
                        default:
                           ...
                           || (HI_UNF_TUNER_SIG_TYPE_DVB_T2 == stSignalInfo.enSigType))
                {
                    switch (stSignalInfo.unSignalInfo.stTer.enModType)
                    {
                        case HI_UNF_MOD_TYPE_QPSK:
                ...
                else if ((HI_UNF_TUNER_SIG_TYPE_CAB == stSignalInfo.enSigType)
                            ||(HI_UNF_TUNER_SIG_TYPE_J83B == stSignalInfo.enSigType))
                {
                ...
                {
                    HI_WARN_TUNER("--IN-->tuner_proc_read,stSignalInfo.enSigType:%d is not support,now.\n");
                }
                break;
        ...
        switch( g_stTunerOps[u32TunerPort].enDemodDevType )
        {
            ...
            case HI_UNF_DEMOD_DEV_TYPE_MN88472:
                ...
                break;
            case HI_UNF_DEMOD_DEV_TYPE_MN88473:
                strncpy(acDemodType, "mn88473", sizeof(acDemodType));
                break;
            case HI_UNF_DEMOD_DEV_TYPE_IT9170:
            ...
            case HI_UNF_DEMOD_DEV_TYPE_TDA18280:
                ...
                break;
			case HI_UNF_DEMOD_DEV_TYPE_HIFDVBC100:
				strncpy(acDemodType, "FDVBC100", sizeof(acDemodType));
				break;
			case HI_UNF_DEMOD_DEV_TYPE_HIFJ83B100:
				strncpy(acDemodType, "FJ83B100", sizeof(acDemodType));
				break;
			case HI_UNF_DEMOD_DEV_TYPE_3138:
                strncpy(acDemodType, "hi3138", sizeof(acDemodType));
                break;
			case HI_UNF_DEMOD_DEV_TYPE_ATBM888X:
                strncpy(acDemodType, "atbm888x", sizeof(acDemodType));
                break;
            case HI_UNF_DEMOD_DEV_TYPE_MXL683:
                strncpy(acDemodType, "mxl683", sizeof(acDemodType));
                break;
            case HI_UNF_DEMOD_DEV_TYPE_GX1132:
               	strncpy(acDemodType, "gx1132", sizeof(acDemodType));
                break;
            case HI_UNF_DEMOD_DEV_TYPE_FC8300:
                strncpy(acDemodType, "fc8300", sizeof(acDemodType));
                break;
            default:
                strncpy(acDemodType, "unknown demod", sizeof( acDemodType ) );
                break;
        ...
        switch(g_stTunerOps[u32TunerPort].enTunerDevType)
        {
			...
			case HI_UNF_TUNER_DEV_TYPE_SI2144:
				...
				break;
			case HI_UNF_TUNER_DEV_TYPE_M88TC3800:
				strncpy(acTunerType, "M88TC3800", sizeof(acTunerType));
				break;
			case HI_UNF_TUNER_DEV_TYPE_MXL683:
				strncpy(acTunerType, "MXL683", sizeof(acTunerType));
				break;
            default :
                strncpy(acTunerType, "unknown TUNER", sizeof( acTunerType ) );
                break;
        ...
        else if (HI_UNF_TUNER_SIG_TYPE_ISDB_T == stSignalInfo.enSigType)
        {
            ...
            p += PROC_PRINT(p, "\nEmergencyFlag:\t%d\nPhaseShiftCorr:\t%d\nPartialFlag:\t%d\n",
                    stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.u8EmergencyFlag,
                    stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.u8PhaseShiftCorr,
                    stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.u8PartialFlag);

            for (i = 0; i < 3; i++)
            {
                if (0 == i)
                {
                    if (0 == stSignalInfo.unSignalInfo.stIsdbT.unISDBTLayers.bits.u8LayerAExist)
                    {
                    ...
                    else
                    {
                        ...
                        p += PROC_PRINT(p, "\tLayerSegNum:\t%d\n",stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersAInfoBits.u8LayerSegNum);
                        enLayerModType = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersAInfoBits.enLayerModType;
                        enLayerFECRate = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersAInfoBits.enLayerFECRate;
                        enLayerHierMod = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersAInfoBits.enLayerHierMod;
                    }
                }

                if (1 == i)
                {
                    if (0 == stSignalInfo.unSignalInfo.stIsdbT.unISDBTLayers.bits.u8LayerBExist)
                    {
                    ...
                    else
                    {
                        ...
                        p += PROC_PRINT(p, "\tLayerSegNum:\t%d\n",stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersBInfoBits.u8LayerSegNum);
                        enLayerModType = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersBInfoBits.enLayerModType;
                        enLayerFECRate = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersBInfoBits.enLayerFECRate;
                        enLayerHierMod = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersBInfoBits.enLayerHierMod;
                    }
                }

                if (2 == i)
                {
                    if (0 == stSignalInfo.unSignalInfo.stIsdbT.unISDBTLayers.bits.u8LayerCExist)
                    {
                    ...
                    else
                    {
                        ...
                        p += PROC_PRINT(p, "\tLayerSegNum:\t%d\n",stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersCInfoBits.u8LayerSegNum);
                        enLayerModType = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersCInfoBits.enLayerModType;
                        enLayerFECRate = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersCInfoBits.enLayerFECRate;
                        enLayerHierMod = stSignalInfo.unSignalInfo.stIsdbT.stISDBTTMCCInfo.stIsdbtLayersCInfoBits.enLayerHierMod;
                    }
                }
                ...
                switch (enLayerFECRate)
                {
                 ...
                 acFECRate[sizeof( acFECRate ) - 1] = '\0';
                ...
                switch (enLayerHierMod)
                {
                 ...
                 acHierAlpha[sizeof( acHierAlpha ) - 1] = '\0';
...
#define QTC_WRITE_REG(addr, value)    (*(volatile HI_U8*)(addr) = (value))
#define QTC_READ_REG(addr)            (*(volatile HI_U8*)addr)
...
HI_S32 qam_read_byte(HI_U32 u32TunerPort, HI_U8 u8RegAddr, HI_U8 *pu8RegVal)
{
	...
	else if (HI_UNF_DEMOD_DEV_TYPE_HIFDVBC100 == g_stTunerOps[u32TunerPort].enDemodDevType
