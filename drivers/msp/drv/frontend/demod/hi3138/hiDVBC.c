...
HI_S32 hiDVBC_connect(HI_U32 u32TunerPort,TUNER_ACC_QAM_PARAMS_S *pstChannel)
{
    ...
    if(i>=u32Chk)
    {
        HI_WARN_TUNER("--IN-->HI3138_C_LOCK_FLAG:%d\n",u8Temp);
        return HI_FAILURE;
    }
...
HI_S32 hiDVBC_get_ber(HI_U32 u32TunerPort, HI_U32 * pu32BERa)
{
    ...
    if(HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER("-->IN--hiDVBC_get_lock_flag:HI3138_C_FEC_LOCK_FLAG failed.\n");
        return s32Ret;
    }
...
HI_S32 hiDVBC_get_snr(HI_U32 u32TunerPort, HI_U32 * pu32SignalStrength)
{
    ...
    if(HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER("-->IN--hiDVBC_get_lock_flag:HI3138_C_EQU_LOCK_FLAG failed.\n");
        return s32Ret;
    }
...
HI_S32 hiDVBC_get_signal_strength(HI_U32 u32TunerPort, HI_U32 * pu32strength)
{
    ...
    if(HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER("-->IN--hiDVBC_get_lock_flag:HI3138_C_AGC_LOCK_FLAG failed.\n");
        return s32Ret;
    }
