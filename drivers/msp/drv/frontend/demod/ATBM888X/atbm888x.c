...
#define TUNER_BYPASS_ENABLE 0  /* 1: use demod bypass i2c to control tuner; 0: don't use demod bypass i2c */
...
int ATBMPowerOnInit(void)
{
	...
	stCustomConfig.stTsMode.ui8OutputEdge               = TS_OUTPUT_FAILING_EDGE;    
