...
{
    HI_U8   u8Temp = 0, temp = 0, temp1 = 0, temp2 = 0;
    HI_U32  ErrorRate = 0;
    HI_U32  a, b;
    HI_U32  total_num = 0, temp3 = 0;
    ...
    if (hi3136_Read_Lock_Status(u32TunerPort) >= SYNC_LOCKED)
    {
        ...
        case 0:
            {   //DVBS
                ...
                temp3 = (temp1 << 8) + temp2;
                ErrorRate = temp3 * 100000 / total_num * 10000;
            }
            break;
...
HI_S32 hi3136_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo)
{
    ...
    HI_U8   temp1=0, temp2=0, temp3=0, u8Temp=0, u8Temp1=0;
    HI_U8   u8CCMMode = 0;
...
{
    HI_U8 j = 0, m = 0, u8Temp = 0, tempL = 0, tempH = 0, temp_TPnum = 0;
    ...
    HI_U32 reliablity_temp1 = 0, reliablity_temp2 = 0, reliablity_temp3 = 0, quit_point = 0, fs_grade = 0;
    HI_S16 cbs_fc = 0, cbs_fc_sel = 0;
    HI_S32 s32FuncRet = HI_SUCCESS;
    HI_U32 scan_time = 0, scan_wait_s1, scan_wait_s2_8, scan_wait_s2_q, scan_ok_wait, pre_reliablity, fec_num_all, fec_num_cnt = 0, try_enough = 0, tp_all = 0, u32temp = 0;
