...
rZsbnRY/kmSqLcQyXx0LLlDsTUSZHr8Zr8N5zxE0jEGuj/miNW8JN3JfZuyRwEet2+1YqJYs
zM+bRcmZM6e29dEWusNVQnV9BDkWjxuvIxsmTnuJ5pstCAyPLRiLmmh8Lu6qtw==#*/
...
enum PixelFormat avcodec_get_pix_fmt(const char *name)
{
    ...
    for (i = 0; i < PIX_FMT_NB; i++)
        if (!strncmp(pix_fmt_info[i].name, name, Max_STRNCMP_LEN))
        { return i; }
