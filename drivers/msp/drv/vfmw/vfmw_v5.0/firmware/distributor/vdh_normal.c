...
03IHVoz7p84MrUtPuSqJrl3WEWsZf0OKEw/7rq5Ljuk9aUFDOnaQ+saf5NQDF38pOEx4F3F8
5HlyC/3fXVvddLBNJWuZZUpd3ZWti9a51aliyzdapGNe+abg72VvO+pWXHtTzw==#*/
...
/*=============== EXTERN VALUE =================*/
extern SINT32 g_VfmwEnableFlag;
...
SINT32 VDH_Write_Proc(struct file *file, const char __user *buffer, size_t count, loff_t *data)
{
    ...
    else
    {
        ...
        if (!strncmp(str1, VDH_CMD_HAL, VDH_CMD_LEN))
        {
