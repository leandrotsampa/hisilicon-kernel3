...
03IHVtDFy9bur1be3kP/JSBup+b6c6Yrd98s2MwS95ZZzqmhWsZFaMLjmGG6Epm7Q8FPAwR3
Ldd2rvuKblRr1em85O4M6MhfR7X90YQNN7sAy6Qgrx/SzpHzrqCfHgfv/+duBQ==#*/
...
SINT32 VDH_Map_ShareData(VDH_SHARE_DATA_S *pShareData)
{
    ...
    g_SecureCtx.pCommonContext = SOS_NsMem_Map(pShareData->common_context);
...
{    
    ...
    SOS_NsMem_Unmap(g_SecureCtx.pCommonContext);
