...
Vboa6aPscGoyWe3p7iRzyMent0VEkC+LoV8zkgFl6IskFR5Xtao/MXPvnovzc4jFOotvAz6A
HvVBZYzHTNQFPpGFd7I04GL796+HoWv9Dgj/HP9DTArwS+zsllQRmo5geFnOEQ==#*/
...
SINT32 OSAL_InitEvent_l( KERN_EVENT_S_L *pEvent, SINT32 InitVal )
{
...
VOID InitVfmwInterface(VOID)
{
    ...
    vfmw_Osal_Func_Ptr_S.pfun_Osal_vfmw_proc_exit = (FN_OSAL_VDEC_Exit)vfmw_proc_exit;
