...
Vboa6bvQeRsFyIzcq4L47RgrWtXMzP6Mk+H/GuAflRWxeX/haJh83rDWapTNQQGYHPtH6wfG
kAqx/PBkIS7IQtpXpireU/MBTBRfGLxHqzvM7npnrs8vj+jGebhZy8mnLL/sBg==#*/
...
int vfmw_read_proc(struct seq_file *p, void *v)
{
    ...
    seq_printf(p, "%-35s :%d\n", "VfmwEnableFlag",     g_VfmwEnableFlag);
