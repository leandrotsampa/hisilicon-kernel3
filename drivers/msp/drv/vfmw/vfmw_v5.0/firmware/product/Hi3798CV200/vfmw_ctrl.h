...
typedef struct hiVFMW_CHAN_MEM_S
{
    ...
    MEM_RECORD_S        *pChanMem_dsp;             /* 指向该通道的DSP上下文存储资源 */
...
typedef struct hiVFMW_CHAN_S
{
	...
	SINT32         s32IsImgOutputEn; /*0: Image 输出不使能，1:Image 输出使能 add by l00228308*/
#endif
...
#ifdef DOLBY_VISION_HDR_SUPPORT
VOID VCTRL_GetChanRpuSize(SINT32 FrmNum, SINT32 *s32ChanRpuSize);
#endif
