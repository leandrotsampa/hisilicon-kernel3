...
//HEVC syntax performance optimization enable //z00290437
#define HEVC_SYNTAX_OPT

#define GETPTS_TEST  //@F00241306 proceed Dolby HDR pts info
//#define GETPTS_TEST_print
...
#endif
//macros
#if !defined (CFG_HEVC_MAX_CU_DEPTH)              //z00290437
...
typedef struct HEVC_SEI_PTS_PARSER_S_
{
    ...
    UINT32 initial_cpb_removal_delay_1st;
    UINT32 initial_cpb_removal_delay_last;

    UINT32 last_gop_size;
    UINT32 cpb_removal_delay;
    UINT32 dpb_output_delay;
    UINT64 u64_dpb_output_time;
    UINT64 u64_frame_output_time;
    //UINT8  delta_to_divisor;
...
typedef struct
{
    ...
    SINT32 i_init_cpb_removal_delay_offset;
    SINT32 i_derived_cpb_delay_offset;
    SINT32 i_derived_dpb_delay_offset;
#endif    
...
typedef struct
{
    ...
    UINT32 nesting_max_temporal_id_plus1[HEVC_MAX_NESTING_NUM_LAYER];   //z00290437  20141028
...
#ifdef GETPTS_TEST
HI_VOID HEVC_Sei_ParsePts_Init(HEVC_CTX_S *pHevcCtx);
HI_VOID HEVC_Sei_Get_Dpb_Output_Time(HEVC_CTX_S *pHevcCtx, HEVC_SEI_PIC_TIMMING_S *pPic, HEVC_VUI_PARAM_SET_S *pVui);
HI_VOID HEVC_Get_Last_IDR_Frame_Info(HEVC_CTX_S *pHevcCtx, UINT32 nal_unit_type);
HI_VOID HEVC_Sei_Get_Frame_Pts(HEVC_CTX_S *pHevcCtx);
#endif
