...
#define HDR_10_SUPPORT //@f00241306 for metadata 2015-07-31
...
typedef enum
{
    ...
    EVNT_POST_MODULE_OCCUPY_FRAMES,
#else	
...
VOID   VDEC_Set_ClockSkip(UINT32 SkipValue);
