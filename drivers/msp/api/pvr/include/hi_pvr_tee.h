...
HI_S32 HI_PVR_TeeCopyToREE(PVR_REE_BUFFER_INFO_S *pstReeBuf, HI_U32 u32TeeChnId);

HI_S32 HI_PVR_TeeGetReeBuffInfo(PVR_REE_BUFFER_INFO_S *psteeBuf, 
                                HI_U8 **ppu8DataAddr, HI_U32 *pu32Len);
HI_S32 HI_PVR_TeeAdjustTsData(HI_UNF_DMX_REC_DATA_INDEX_S *pstDmxRecData, 
                              HI_U32 u32TeeChnId, 
                              HI_U64 u64DropLength,
                              PVR_REE_BUFFER_INFO_S *pstReeBuff);
HI_S32 HI_PVR_TeeCopyTsDataFromRee(PVR_REE_BUFFER_INFO_S *pstReeBuf, HI_UNF_STREAM_BUF_S *pstSecDmxBuf, HI_S32 s32Len);
HI_S32 HI_PVR_TeeGetTeeState(HI_U32 u32TeeChnId, PVR_REE_BUFFER_INFO_S *pstTeeState);
HI_S32 HI_PVR_TeeMallocReeBuffer(PVR_REE_BUFFER_INFO_S *pstReeBuf, HI_S32 s32Length, HI_BOOL bShare);
HI_S32 HI_PVR_TeeFreeReeBuffer(PVR_REE_BUFFER_INFO_S *pstReeBuf, HI_BOOL bShare);
#if 0
HI_S32 HI_PVR_TeeAttach(HI_U32 u32TeeChnId, HI_HANDLE hDemuxHandle);
#endif
HI_S32 HI_PVR_TeeCalcBuffInfo(HI_U32 *pu32Len, HI_U32 u32TeeChnId);
