...
HI_S32 HI_PVR_RegisterExtendCallback(HI_U32 u32ChnID, HI_UNF_PVR_EXTRA_CALLBACK_E eExtraCallbackType, ExtendCallBack fCallback, HI_VOID *pUserData);

HI_S32 HI_PVR_UnRegisterExtendCallBack(HI_U32 u32ChnID, HI_UNF_PVR_EXTRA_CALLBACK_E eExtraCallbackType, ExtendCallBack fCallback);
