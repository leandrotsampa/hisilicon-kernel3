...
#if 0
#define AUDIO_UNFFRAME2DRVFRAME(pstUnfFrame, pstDrvFrame) \
    do \
    { \
        ...
        (pstDrvFrame)->tPcmBuffer  = (HI_VIRT_ADDR_T)((pstUnfFrame)->ps32PcmBuffer - HI_NULL); \
        (pstDrvFrame)->tBitsBuffer = (HI_VIRT_ADDR_T)((pstUnfFrame)->ps32BitsBuffer - HI_NULL); \
    } while (0)

#define AUDIO_DRVFRAME2UNFFRAME(pstDrvFrame, pstUnfFrame) \
    do \
    { \
