...
/**
\brief Get mem size of compression surface. CNcomment:获取压缩surface所需的内存大小CNend
\attention \n
Mem size of compression surface is different with no compress surface.So call this interface to get stride instead of using stride * height.\n
CNcomment:压缩surface的内存大小与非压缩surface不一样,不能通过stride * height来计算,需使用此接口获取,然后分配相应大小的内存CNend

\param[in]	enDevId Device id. CNcomment:设备号CNend
\param[in]	u32Width Width of surface. CNcomment:surface的宽度CNend
\param[in]	u32Height Height of surface. CNcomment:surface的高度CNend
\param[in]	enFmt Color format of surface. CNcomment:surface的像素格式CNend
\param[out]	pu32Size Mem size of surface. CNcomment:surface的内存大小CNend
\retval 0 Success. CNcomment:成功CNend
\retval ::HI_ERR_GFX2D_INVALID_DEVID Invalid device id. CNcomment:不正确的设备号CNend
\retval ::HI_ERR_GFX2D_DEV_NOT_OPEN Device not opened. CNcomment:设备未打开CNend
\retval ::HI_ERR_GFX2D_NULL_PTR Null pointer param. CNcomment:空指针参数CNend
\retval ::HI_ERR_GFX2D_INVALID_SURFACE_FMT Invalid color format,now only support ARGB8888 in compression surface. CNcomment:不正确的像素格式，现在压缩surface仅支持ARGB8888格式CNend
\retval ::HI_ERR_GFX2D_INVALID_SURFACE_RESO Invalid width or height,width of compression surface must be even. CNcomment:不正确的宽度或者高度，压缩surface的宽度必须为偶数CNend
\see N/A
*/
...
/**
\brief Get stride of cmpression surface. CNcomment:获取压缩surface的行间距CNend
\attention \n
Stride of compression surface is different with no compress surface.So call this interface to get stride instead of using Bpp * width.\n
CNcomment:压缩surface的stride与非压缩surface的不一样,不能通过Bpp * width来计算,需使用用此接口获取\n CNend

\param[in]	enDevId Device id. CNcomment:设备号CNend
\param[in]	u32Width Width of surface. CNcomment:surface的宽度CNend
\param[in]	enFmt Color format of surface. CNcomment:surface的像素格式CNend
\param[out]	pu32Stride Stride of surface. CNcomment:surface的行间距CNend
\retval 0 Success. CNcomment:成功CNend
\retval ::HI_ERR_GFX2D_INVALID_DEVID Invalid device id. CNcomment:不正确的设备号CNend
\retval ::HI_ERR_GFX2D_DEV_NOT_OPEN Device not opened. CNcomment:设备未打开CNend
\retval ::HI_ERR_GFX2D_NULL_PTR Null pointer param. CNcomment:空指针参数CNend
\retval ::HI_ERR_GFX2D_INVALID_SURFACE_FMT Invalid color format,now only support ARGB8888 in compression surface. CNcomment:不正确的像素格式，现在压缩surface仅支持ARGB8888格式CNend
\retval ::HI_ERR_GFX2D_INVALID_SURFACE_RESO Invalid width,width of compression surface must be even. CNcomment:不正确的宽度，压缩surface的宽度必须为偶数CNend
\see N/A
*/
...
/**
\brief Initial instance of HI_GFX2D_SURFACE_S. CNcomment:初始化HI_GFX2D_SURFACE_S实例CNend
\attention N/A
\param[in]	enDevId Device id. CNcomment:设备ID号CNend
\param[out]	pstSurface Instance of HI_GFX2D_SURFACE_S. CNcomment:HI_GFX2D_SURFACE_S实例CNend
\retval 0 Success. CNcomment:成功CNend
\retval ::HI_ERR_GFX2D_INVALID_DEVID Invalid device id. CNcomment:不正确的设备号CNend
\retval ::HI_ERR_GFX2D_DEV_NOT_OPEN Device not opened. CNcomment:设备未打开CNend
\retval ::HI_ERR_GFX2D_NULL_PTR Null pointer param. CNcomment:空指针参数CNend
...
/**
\brief Initial instance of HI_GFX2D_COMPOSE_OPT_S. CNcomment:初始化HI_GFX2D_COMPOSE_OPT_S实例CNend
\attention N/A
\param[in]	enDevId Device id. CNcomment:设备ID号CNend
\param[out]	pstOpt Instance of HI_GFX2D_COMPOSE_OPT_S. CNcomment:HI_GFX2D_COMPOSE_OPT_S实例CNend
